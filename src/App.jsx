      ...
      <div style={{padding:"12px 14px"}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",gap:10}}>
          ...
          <button
            onClick={onExecute}
            disabled={isExecuted}
            style={{...sbtn(isExecuted?SM.muted:cat.color,{fontSize:10,padding:"6px 12px",flexShrink:0,opacity:isExecuted?0.6:1,background:isExecuted?SM.bgCard:cat.color,border:`1px solid ${cat.color}40`,color:isExecuted?SM.muted:"#fff"})}}
          >
            {isExecuted?"✓ In Tracker":"Choose to Execute"}
          </button>
        </div>
      </div>
