...
const INDUSTRIES = [
  {
    ...
    decisions:[
      {cat:"Revenue",    q:"Best treatment to push this month?", a:"Filler treatments: S$480/hr, only 8% cancellation. Shift 2 facial slots/day → +S$4,200/month revenue.", promo:"Tuesday slots are 38% utilised at Lumière Clinic. Run a Tuesday exclusive: 15% off filler treatments for existing clients this week only. Limited slots — book via WhatsApp."},
      {cat:"Cost",       q:"Where am I losing margin?",          a:"Tuesday 2–5pm is 38% utilised vs 91% Friday. Empty slots cost S$1,100/week in lost revenue.", promo:"Hi-value Tuesday exclusive: book a facial or filler this Tuesday at Lumière Clinic and receive a complimentary skin consultation (worth S$80). 3 slots remaining."},
  ...
  },
  {
    ...
    decisions:[
      {cat:"Revenue",    q:"How do I grow recurring revenue?",   a:"RM199 unlimited pass viable at 35+ uptake. 180 drop-ins/month → 20% conversion = 36 members = RM7,164/month new MRR.", promo:"Introducing the Apex Unlimited Pass — all classes, all outlets, for RM199/month. Launching this Friday. First 30 sign-ups get a free protein shaker. Offer ends Sunday."},
  ...
  },
  {
    ...
    decisions:[
      {cat:"Revenue",    q:"What should I promote this week?",  a:"Signature coffee + cake combo: S$18.50, 72% margin. Currently 12% of orders. Push to 20% → +S$3,200/month revenue.", promo:"This week at Chapters Café: our signature coffee + cake combo for just S$18.50. A perfect afternoon treat — available at both outlets, while stocks last. See you soon!"},
  ...
  },
  {
    ...
    decisions:[
      {cat:"Revenue",    q:"What to push for the next 30 days?", a:"Scented candles: S$85 ASP, 68% margin, 6.2x turns/year. Currently 9% of revenue. Push to 15% → +S$6,700/month.", promo:"New arrival alert at Atelier HOME: our curated scented candle collection is back in stock. Hand-poured, long-burn, exclusive to us. Shop in-store or reply to reserve yours."},
        ...
        {activeDec&&(
          <div style={{background:SM.bgSec,borderRadius:8,padding:"14px 16px",border:`1px solid ${SM.border}`}}>
            ...
            <div style={{display:"flex",gap:8,marginTop:10,flexWrap:"wrap"}}>
              <button onClick={()=>setPage("copilot")} style={{...sbtn(industry.color,{fontSize:11,padding:"6px 12px"}),...{background:"transparent",color:industry.color,border:`1px solid ${industry.color}40`}}}>
            ...
            <WhatsAppSender
              industry={industry}
              trigger="dashboard"
              context={activeDec.promo||`${activeDec.q} — ${activeDec.a}`}
              tier="growth"
            />
          </div>
        )}
