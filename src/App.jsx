...
// ── SME DESIGN TOKENS ────────────────────────────────────────────────────────
const SM = {
  bg:"#f8fafc", bgCard:"#ffffff", bgSec:"#f1f5f9",
  border:"rgba(0,0,0,0.08)", borderStrong:"rgba(0,0,0,0.15)",
  navy:"#0f172a", blue:"#1d4ed8", blueLight:"#eff6ff",
...
function SmeDashboard({industry, setPage}){
  ...
  return(
    <div style={{flex:1,overflowY:"auto",padding:20,background:SM.bg,display:"flex",flexDirection:"column",gap:14}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:10}}>
          {industry.kpis.map(k=>(
            <div key={k.label} style={{...scard(),position:"relative",overflow:"hidden"}}>
              ...
              <div style={{fontSize:20,fontWeight:800,color:SM.navy,letterSpacing:-0.5,marginBottom:2}}>{k.value}</div>
              <div style={{display:"flex",alignItems:"center",gap:6}}>
      ...
      {/* Decision Framework */}
      <div style={scard()}>
        <div style={{fontSize:12,fontWeight:800,color:SM.navy,marginBottom:3}}>My Decisions This Week</div>
        ...
        {activeDec&&(
          <div style={{background:SM.bgSec,borderRadius:8,padding:"14px 16px",border:`1px solid ${SM.border}`}}>
            <div style={{fontSize:11,fontWeight:700,color:SM.muted,marginBottom:4,textTransform:"uppercase",letterSpacing:1,fontFamily:"'JetBrains Mono',monospace"}}>{activeDec.cat} Question</div>
            <div style={{fontSize:13,fontWeight:700,color:SM.navy,marginBottom:10}}>"{activeDec.q}"</div>
            <div style={{background:SM.bgCard,borderRadius:6,padding:"10px 14px",border:`1.5px solid ${industry.color}30`}}>
              ...
              <div style={{fontSize:12,color:SM.navy,lineHeight:1.6}}>{activeDec.a}</div>
            </div>
      ...
      {/* Benchmarks */}
      <div style={scard()}>
        <div style={{fontSize:12,fontWeight:800,color:SM.navy,marginBottom:10}}>How You Compare — SEA Industry Benchmarks</div>
          ...
          {industry.benchmarks.map(b=>{
            ...
            return(
              <div key={b.metric} style={{display:"grid",gridTemplateColumns:"2fr 80px 1fr 100px",gap:8,alignItems:"center",padding:"8px 10px",background:SM.bgSec,borderRadius:6}}>
                <span style={{fontSize:11,fontWeight:600,color:SM.navy}}>{b.metric}</span>
  ...
  return(
    <div style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden",background:SM.bg}}>
      <div style={{padding:"12px 20px",borderBottom:`1px solid ${SM.border}`,background:SM.bgCard,flexShrink:0}}>
        <div style={{fontSize:12,fontWeight:700,color:SM.navy,marginBottom:6}}>Quick Questions — tap to ask instantly</div>
        <div style={{display:"flex",gap:7,flexWrap:"wrap"}}>
...
function SmeROITracker({industry}){
  ...
  return(
    <div style={{flex:1,overflowY:"auto",padding:20,background:SM.bg,display:"flex",flexDirection:"column",gap:14}}>
      ...
      {/* Decisions breakdown */}
      <div style={scard()}>
        <div style={{fontSize:12,fontWeight:800,color:SM.navy,marginBottom:12}}>Decision Outcomes — Tracked by Aether</div>
          ...
          {industry.roiItems.map((r,i)=>{
            ...
            return(
              <div key={i} style={{display:"flex",alignItems:"center",gap:12,background:SM.bgSec,borderRadius:8,padding:"12px 14px",border:`1px solid ${SM.border}`}}>
                ...
                <div style={{flex:1}}>
                  <div style={{fontSize:12,fontWeight:600,color:SM.navy,marginBottom:2}}>{r.action}</div>
...
function SmeApp({onBack}){
  ...
  if(!industry){
    return(
      <div style={{height:"100vh",background:SM.bg,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:40,fontFamily:"'Inter',system-ui,sans-serif"}}>
        <style>{GS}</style>
        ...
        <div style={{textAlign:"center",marginBottom:40}}>
          ...
          <div style={{fontSize:26,fontWeight:800,color:SM.navy,marginBottom:6}}>What kind of business are you?</div>
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(2,1fr)",gap:16,width:"100%",maxWidth:580}}>
          {INDUSTRIES.map(ind=>(
            <button key={ind.id} onClick={()=>setIndustry(ind)} style={{...scard(),cursor:"pointer",textAlign:"left",border:`1.5px solid ${SM.border}`,transition:"all 0.18s",padding:"20px 22px",position:"relative",overflow:"hidden",background:SM.bgCard}}
            ...
            >
              ...
              <div style={{fontSize:15,fontWeight:800,color:SM.navy,marginBottom:4}}>{ind.label}</div>
    ...
    <div style={{display:"flex",height:"100vh",background:SM.bg,fontFamily:"'Inter',system-ui,sans-serif",color:SM.text,overflow:"hidden"}}>
      ...
      <aside style={{width:210,flexShrink:0,background:SM.bgCard,borderRight:`1px solid ${SM.border}`,display:"flex",flexDirection:"column",overflow:"hidden"}}>
        <div style={{padding:"14px 16px",borderBottom:`1px solid ${SM.border}`,display:"flex",alignItems:"center",gap:10}}>
          ...
          <div>
            <div style={{fontSize:12,fontWeight:800,color:SM.navy,letterSpacing:-0.3,lineHeight:1}}>{industry.bizName}</div>
      ...
      <main style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden"}}>
        <div style={{height:50,borderBottom:`1px solid ${SM.border}`,display:"flex",alignItems:"center",justifyContent:"space-between",padding:"0 20px",flexShrink:0,background:SM.bgCard}}>
          <div>
            <div style={{fontSize:13,fontWeight:700,color:SM.navy}}>{SME_NAV.find(n=>n.id===page)?.label||"Dashboard"}</div>
  ...
  return(
    <div style={{height:"100vh",background:"#080c18",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:40,fontFamily:"'Inter',system-ui,sans-serif"}}>
      ...
      <div style={{textAlign:"center",marginBottom:48}}>
        ...
        <div style={{fontSize:15,color:"#64748b"}}>Enterprise Decision Intelligence · Southeast Asia</div>
      </div>
