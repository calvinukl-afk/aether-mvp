...
const INDUSTRIES = [
  ...
  {
    id:"aesthetic", label:"Aesthetic Clinic", icon:"✨", color:"#ec4899",
    bizName:"Glow Clinic", location:"Orchard Road, Singapore", outlets:1,
    currency:"S$", currencyCode:"SGD",
    kpis:[
      {label:"Monthly Revenue",    value:"S$148,000", change:"+8.2%",  pos:true,  sub:"vs S$136,800 last month"},
      {label:"Avg Treatment Value",value:"S$680",     change:"+S$45",  pos:true,  sub:"Upsell programme working"},
      {label:"New Clients MTD",    value:"38",         change:"+6",     pos:true,  sub:"vs 32 last month"},
      {label:"Repeat Visit Rate",  value:"62%",        change:"-4pp",   pos:false, sub:"Industry norm: 70–75%"},
      {label:"Profitability",      value:"S$29,600",   change:"+12.1%", pos:true,  sub:"20.0% EBITDA margin"},
      {label:"Treatment Utilisation",value:"71%",      change:"-3pp",   pos:false, sub:"3 rooms · 9hrs/day"},
    ],
    questions:[
      "Which treatments have the highest margin and should we push more?",
      "My repeat visit rate dropped to 62% — what's driving the churn?",
      "How do I fill the 29% room utilisation gap this month?",
      "Should I introduce a membership or package programme?",
      "Which new treatments should I add to grow revenue?",
      "How do I compete with the new aesthetic clinic that opened nearby?",
      "Is my pricing in line with the Orchard Road market?",
      "Should I invest in a new laser machine?",
    ],
    decisions:{
      revenue:[
        {q:"Which treatment should we push this month?", a:"Skin Booster (Juvederm Hydrate): S$980/session, 74% margin, 85-min chair time. Currently 11% of bookings. Push to 18% → +S$9,800/month. Existing clients with 3+ visits are most likely to convert.", impact:"S$9,800/mo", promo:"Glow Clinic this month: our most-loved Skin Booster treatment — plump, dewy skin that lasts 6 months. Limited slots this week. Reply YES to check your availability."},
        {q:"How do we grow package sales?", a:"Clients who buy a 3-session package have 2.8x higher lifetime value. Current package uptake: 22%. Move to 35% with post-treatment upsell script. At 12 new package sales/month = S$31,000 locked-in revenue.", impact:"S$31,000 MRR", promo:"Glow Clinic 3-Session Skin Booster Package: S$2,600 (save S$340). Book all 3 now and secure your preferred time slots. Only 5 packages left at this price."},
        {q:"Should we introduce a VIP membership?", a:"Monthly membership at S$380: includes 1 facial + 15% off all treatments. At 60 members = S$22,800 guaranteed MRR. Your 380+ repeat clients are the target. Churn risk offset by commitment.", impact:"S$22,800/mo", promo:"Introducing the Glow Club — monthly membership for S$380. One facial every month + 15% off all treatments. Founding member rate locked for life. Only 20 spots available."},
      ],
      profitability:[
        {q:"What is our most profitable treatment?", a:"Profitability ranking: BTX injections (S$420, 82% margin, 20min), Skin Boosters (S$980, 74%, 85min), Peels (S$280, 71%, 45min). BTX delivers S$1,260/hr vs Laser Hair Removal at S$380/hr. Shift room allocation accordingly.", impact:"S$8,400/mo"},
        {q:"Are we losing money on any treatments?", a:"Laser Hair Removal (full body): S$580 revenue, 44% margin, 90min. Effective rate: S$387/hr. Below clinic average of S$610/hr. Price increase to S$680 or reduce session time to 75min. Both viable.", impact:"S$3,200/mo"},
        {q:"How do we reach 22% EBITDA?", a:"Current 20%. Gap: S$3,000/month. Levers: push BTX bookings +4/week (+S$1,680), membership launch (+S$2,500 in month 2), reduce supply wastage (-S$800). 23% EBITDA achievable by month 3.", impact:"S$4,980/mo"},
      ],
      pricing:[
        {q:"Are our prices in line with the Orchard market?", a:"Benchmarking vs 8 comparable Orchard clinics: your BTX is 8% below market (S$420 vs S$455 median). Skin Boosters: 3% below (S$980 vs S$1,010). Recommend raising BTX to S$450 and Booster to S$1,020. Low churn risk for loyal clients.", impact:"S$5,600/mo"},
        {q:"Should I run a new client promotion?", a:"New client first-visit offer at S$199 (mini facial + skin analysis) drives acquisition at 3.2x higher conversion than standard consult. Cap at 20 slots/month to protect revenue mix. Break-even at 40% rebooking rate — your rate is 68%.", impact:"S$8,200/mo"},
        {q:"Can I increase prices without losing clients?", a:"Loyalty analysis: clients with 4+ visits show <8% price sensitivity. 214 clients qualify. A 6% price increase on non-promotional treatments affects only price-sensitive new clients (32% of revenue). Net impact: +S$4,100/month with <3% volume loss.", impact:"S$4,100/mo"},
      ],
      cost:[
        {q:"Where is my product/supply cost running high?", a:"Consumables at 18.4% of revenue vs 14–16% industry norm. Top overspend: Skin Booster syringes (ordering monthly in small quantities — 26% price premium). Switch to quarterly bulk order → save S$2,100/month.", impact:"S$2,100/mo"},
        {q:"Are my staff hours optimised?", a:"3 therapists scheduled 9am–6pm daily including Tuesday (lowest booking day: 41% utilisation). Tuesday half-day schedule for 1 therapist saves S$880/month with no client impact. Redeploy those hours to Saturday peak.", impact:"S$880/mo"},
        {q:"Should I renew my equipment lease or buy?", a:"Current laser lease: S$3,800/month. Purchase equivalent machine: S$68,000 (18-month payback at current utilisation). At 71% utilisation, purchase justified. At lease renewal, negotiate or buy outright.", impact:"S$45,600 over 3yr"},
      ],
      ops:[
        {sev:"critical", title:"3 No-Shows This Week — Zero Deposit Policy", detail:"Tuesday: 3 no-shows, 2.25 hrs of room time lost = S$1,368 revenue lost. No deposit collected. Industry standard: S$50–100 deposit on all bookings over S$300.", time:"This week", src:"BOOKINGS", action:"Implement S$80 deposit for all bookings above S$300. Update booking confirmation SMS to reflect policy. Apply from next Monday."},
        {sev:"warning",  title:"Repeat Visit Rate Declining — 62% vs 70% Target", detail:"Repeat visit rate dropped 4pp in 2 months. Root cause: no structured follow-up programme. Clients leaving with no next appointment booked and no reactivation touchpoint at 6 weeks.", time:"Ongoing", src:"CRM", action:"Implement 6-week reactivation WhatsApp for all single-visit clients. Script: 'Your skin is ready for its next treatment — [treatment recommendation]. Shall we book you in?' Target: 15 reactivations/month."},
        {sev:"info",     title:"Google Reviews — Response Rate 0%", detail:"14 Google reviews in last 30 days, 4.7 average. Zero responses from clinic. Responding to reviews increases trust signals and improves local SEO ranking. Top competitors respond to 90%+ of reviews.", time:"Ongoing", src:"REVIEWS", action:"Respond to all 14 existing reviews this week. Set up weekly review monitoring. Assign front desk to respond within 24 hours."},
      ],
      feedback:[
        {source:"Google Reviews", rating:"4.7/5", trend:"+0.1", count:"14 reviews this month", insight:"Top praise: doctor expertise and aftercare advice (11 mentions). One recurring concern: waiting times exceeding 15 minutes past appointment. Fixable with tighter scheduling buffers."},
        {source:"Post-Treatment Survey", rating:"91% satisfied", trend:"+3pp vs last month", count:"52 responses", insight:"Satisfaction highest for BTX and Skin Booster (94%). Lowest for Laser Hair Removal (84%) — clients expect faster results. Manage expectations at consultation stage with realistic timeline."},
        {source:"Rebooking Data", rating:"62% rebooked within 8 weeks", trend:"-4pp", count:"of 124 treated clients", insight:"Rebooking rate highest when next appointment booked before client leaves (78% show rate). Only 34% of clients currently booked before leaving. Train front desk to book next appointment at checkout — target 65%+ pre-booked."},
      ],
      org:[
        {q:"Do I need a dedicated client coordinator?", a:"Doctor and therapists currently handling all rebooking and follow-up calls: 8hrs/week. A part-time client coordinator at S$1,400/month handling rebooking, reviews, and follow-up WhatsApp recovers est. S$4,800/month in reactivated visits.", impact:"+S$3,400/mo net"},
        {q:"Should I hire a second doctor?", a:"Current doctor utilisation: 74% of available hours. At 80%+ you risk burnout and quality risk. A second part-time doctor (2 days/week at S$4,500/month) unlocks 18 additional BTX slots — at S$420 each: +S$7,560 revenue potential.", impact:"+S$3,060/mo net"},
        {q:"How do I retain my lead therapist?", a:"Lead therapist revenue contribution: S$41,000/month (28% of total). Market rate for comparable therapists: S$3,400–3,800/month. Current salary: S$3,200. Retention risk is high. Recommend immediate salary review + commission structure.", impact:"Retention critical"},
      ],
      expansion:[
        {q:"Should I open a second outlet?", a:"Current outlet: 71% utilisation, S$29,600 profit. A second outlet requires S$120,000 setup + 6 months break-even. With current revenue growth (+8% MoM), Year 2 payback is feasible. But first: hit 80% utilisation and 65% repeat rate at Outlet 1.", impact:"Year 2 payback"},
        {q:"Which new treatments should I add?", a:"High-margin adjacencies with existing equipment: Profhilo (S$1,100/session, 76% margin, minimal consumables), Exosome treatment (S$1,400, 78% margin, growing 40% YoY in SG). Both require 2-day doctor training. Low entry cost, high upside.", impact:"S$18,000/mo potential"},
        {q:"Should I launch an e-commerce skincare line?", a:"A clinic-branded skincare range (3 SKUs: cleanser, serum, SPF) at S$65–120 retail. 340 active clients × 60% purchase intent = 204 units/month = S$15,300 additional revenue. Gross margin 62%. Low risk, high trust factor from clinic brand.", impact:"S$15,300/mo"},
      ],
    },
    roiItems:[
      {action:"BTX push — +4 sessions/week", value:"S$6,720", type:"revenue"},
      {action:"Deposit policy — no-show reduction", value:"S$5,472", type:"protected"},
      {action:"Reactivation WhatsApp — 15 clients/month", value:"S$10,200", type:"revenue"},
      {action:"Bulk supply order — quarterly", value:"S$2,100", type:"saved"},
    ],
    benchmarks:[
      {metric:"Repeat Visit Rate", yours:"62%", industry:"70–75%", status:"below"},
      {metric:"Room Utilisation", yours:"71%", industry:"75–85%", status:"below"},
      {metric:"EBITDA Margin", yours:"20.0%", industry:"18–24%", status:"ok"},
      {metric:"Consumables % Revenue", yours:"18.4%", industry:"14–16%", status:"above"},
      {metric:"Avg Treatment Value", yours:"S$680", industry:"S$580–720", status:"ok"},
    ],
  },
];
...
// ── CUSTOMER SALES ENGAGEMENT PANEL ──────────────────────────────────────────
function CustomerSalesEngagement({industry, onCampaignLog}){
  const[campaigns,setCampaigns]=useState([]);
  const[activeLog,setActiveLog]=useState(null); // campaign id being outcome-logged

  const handleCampaignSent=(campaignData)=>{
    const c={
      id:`camp-${Date.now()}`,
      label:campaignData.label,
      message:campaignData.message,
      trackingId:`T${Math.random().toString(36).substr(2,6).toUpperCase()}`,
    ...
    setCampaigns(p=>[...p,c]);
    if(onCampaignLog) onCampaignLog(c);
  };

  const logOutcome=(id, replies, bookings, revenue)=>{
    setCampaigns(p=>p.map(c=>c.id===id?{...c,replies,bookings,revenue,status:"tracked"}:c));
    setActiveLog(null);
  };

  const simulateClick=(id)=>{
    setCampaigns(p=>p.map(c=>c.id===id?{...c,clicks:c.clicks+1}:c));
  };
  ...
  const quickCampaigns=[
    ...
    {label:"Membership plan",      ctx:`Promote the ${industry.bizName} annual dental care plan at S${industry.currency==="S$"?"380":"380"}/year to existing patients.`},
  ];

  return(
    <div style={{...scard(),display:"flex",flexDirection:"column",gap:0,padding:0,overflow:"hidden"}}>
      {/* Header */}
      <div style={{padding:"12px 14px",borderBottom:`1px solid ${SM.border}`,background:`${industry.color}10`}}>
        <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:3}}>
          <span style={{fontSize:16}}>💬</span>
          <div style={{fontSize:13,fontWeight:800,color:SM.text}}>Customer Sales Engagement</div>
          <span style={stag("#25D166")}>WhatsApp</span>
        </div>
        <div style={{fontSize:10,color:SM.muted}}>Generate campaigns · Track clicks · Log outcomes · See real impact</div>
      </div>

      <div style={{padding:"10px 14px",display:"flex",flexDirection:"column",gap:6}}>
        {/* Quick campaigns */}
        {quickCampaigns.map((c,i)=>(
          <EnhancedQuickCampaign key={i} industry={industry} campaign={c} onSent={handleCampaignSent}/>
        ))}
        {/* Custom */}
        <div style={{borderTop:`1px solid ${SM.border}`,paddingTop:8,marginTop:2}}>
          <div style={{fontSize:9,color:SM.muted,fontFamily:"'JetBrains Mono',monospace",letterSpacing:1,marginBottom:5}}>CUSTOM CAMPAIGN</div>
          <EnhancedCustomCampaign industry={industry} onSent={handleCampaignSent}/>
        </div>
      </div>

      {/* Campaign Results */}
      {campaigns.length>0&&(
        <div style={{borderTop:`1px solid ${SM.border}`,padding:"10px 14px",background:SM.bgSec}}>
          <div style={{fontSize:10,fontWeight:700,color:SM.text,marginBottom:8,display:"flex",alignItems:"center",gap:6}}>
            📊 Campaign Results
            <span style={stag(SM.green)}>{campaigns.filter(c=>c.status==="tracked").length}/{campaigns.length} TRACKED</span>
          </div>
          <div style={{display:"flex",flexDirection:"column",gap:6}}>
            {campaigns.map(c=>(
              <div key={c.id} style={{background:SM.bgCard,borderRadius:7,border:`1px solid ${SM.border}`,overflow:"hidden"}}>
                <div style={{padding:"8px 10px",display:"flex",justifyContent:"space-between",alignItems:"center",gap:8}}>
                  <div style={{flex:1,minWidth:0}}>
                    <div style={{fontSize:11,fontWeight:600,color:SM.text,marginBottom:2}}>{c.label}</div>
                    <div style={{display:"flex",gap:8,flexWrap:"wrap",alignItems:"center"}}>
                      <span style={{fontSize:9,fontFamily:"'JetBrains Mono',monospace",color:SM.muted}}>Sent {c.sentAt}</span>
                      <span style={{...stag("#25D166"),display:"flex",alignItems:"center",gap:3}}>
                        🔗 {c.clicks} click{c.clicks!==1?"s":""}
                        <button onClick={()=>simulateClick(c.id)} title="Simulate patient click" style={{fontSize:8,background:"none",border:"none",cursor:"pointer",color:"#25D166",padding:"0 2px"}}>+1</button>
                      </span>
                      {c.status==="tracked"&&(
                        <>
                          {c.replies!=null&&<span style={stag(SM.accent)}>💬 {c.replies} replies</span>}
                          {c.bookings!=null&&<span style={stag(SM.green)}>📅 {c.bookings} booked</span>}
                          {c.revenue&&<span style={{...stag(SM.green),fontWeight:800}}>{industry.currency}{c.revenue}</span>}
                        </>
                      )}
                    </div>
                  </div>
                  {c.status==="sent"&&(
                    <button onClick={()=>setActiveLog(activeLog===c.id?null:c.id)} style={{...sbtn(activeLog===c.id?SM.muted:industry.color,{fontSize:9,padding:"4px 9px",background:activeLog===c.id?SM.bgSec:industry.color,border:`1px solid ${industry.color}40`})}}>
                      {activeLog===c.id?"▲ Close":"Log Results"}
                    </button>
                  )}
                  {c.status==="tracked"&&<span style={stag(SM.green)}>✓ TRACKED</span>}
                </div>

                {/* Outcome logger */}
                {activeLog===c.id&&(
                  <OutcomeLogger campaign={c} industry={industry} onLog={(r,b,rev)=>logOutcome(c.id,r,b,rev)}/>
                )}
              </div>
            ))}
          </div>
...
// ── OUTCOME LOGGER ────────────────────────────────────────────────────────────
function OutcomeLogger({campaign, industry, onLog}){
  const[replies,setReplies]=useState("");
  const[bookings,setBookings]=useState("");
  const[revenue,setRevenue]=useState("");

  return(
    <div style={{padding:"10px 12px",background:`${industry.color}08`,borderTop:`1px solid ${SM.border}`,animation:"fadeIn 0.2s ease"}}>
      <div style={{fontSize:9,fontWeight:700,color:industry.color,letterSpacing:1,fontFamily:"'JetBrains Mono',monospace",marginBottom:8}}>LOG CAMPAIGN OUTCOMES</div>
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:8,marginBottom:8}}>
        {[
          {label:"Replies received",  val:replies,  set:setReplies,  ph:"e.g. 12"},
          {label:"Bookings made",     val:bookings, set:setBookings, ph:"e.g. 8"},
          {label:`Revenue (${industry.currency})`, val:revenue, set:setRevenue, ph:"e.g. 3200"},
        ].map(f=>(
          <div key={f.label}>
            <div style={{fontSize:9,color:SM.muted,marginBottom:3}}>{f.label}</div>
            <input value={f.val} onChange={e=>f.set(e.target.value)} placeholder={f.ph} style={{width:"100%",background:SM.bgCard,border:`1px solid ${SM.border}`,borderRadius:5,padding:"5px 8px",fontSize:11,color:SM.text,outline:"none",fontFamily:"inherit"}}/>
          </div>
        ))}
      </div>
      <button
        onClick={()=>onLog(replies||"0",bookings||"0",revenue||"0")}
        style={{...sbtn(industry.color,{fontSize:10,padding:"5px 12px",width:"100%",justifyContent:"center"})}}
      >
        ✓ Save Outcomes — Track Real Impact
      </button>
    </div>
  );
}

// ── ENHANCED QUICK CAMPAIGN (passes sent data back up) ────────────────────────
function EnhancedQuickCampaign({industry, campaign, onSent}){
  const[step,setStep]=useState("idle");
  const[msg,setMsg]=useState("");
  ...
  const generate=async()=>{
    setStep("generating");
    try{
      const system=`Write a WhatsApp promotional message for ${industry.bizName} (${industry.label}, ${industry.location}). Max 160 chars. Warm, personal. Start with "Hi [Name],". End with business name. Return ONLY the message.`;
      const result=await callClaude([{role:"user",content:campaign.ctx}],system,false,"whatsapp");
      setMsg(result.text.trim());
      setStep("edit");
    }catch(e){
  ...
  const send=()=>{
    ...
    if(onSent) onSent({label:campaign.label,message:msg});
    setStep("sent");
  };

  return(
    <div style={{background:SM.bgSec,borderRadius:7,padding:"7px 10px",border:`1px solid ${SM.border}`}}>
      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8}}>
        <span style={{fontSize:11,color:SM.text,fontWeight:500}}>💬 {campaign.label}</span>
        {step==="idle"&&<button onClick={generate} style={{...sbtn("#25D166",{fontSize:9,padding:"4px 10px",background:"rgba(37,209,102,0.15)",color:"#25D166",border:"1px solid rgba(37,209,102,0.3)"})}}>Generate</button>}
        {step==="generating"&&<span style={{fontSize:9,color:SM.muted,fontFamily:"'JetBrains Mono',monospace"}}>Writing...</span>}
        {step==="sent"&&<span style={{fontSize:9,color:SM.green,fontFamily:"'JetBrains Mono',monospace"}}>✓ Sent · Log results below</span>}
      </div>
      {step==="edit"&&(
        <div style={{marginTop:7}}>
          <textarea value={msg} onChange={e=>setMsg(e.target.value)} rows={3} style={{width:"100%",background:SM.bg,border:"1px solid rgba(37,209,102,0.3)",borderRadius:5,padding:"7px 9px",fontSize:10,color:SM.text,outline:"none",resize:"none",fontFamily:"inherit",lineHeight:1.5}}/>
          <div style={{display:"flex",gap:6,marginTop:5}}>
            <button onClick={send} style={{...sbtn("#25D166",{fontSize:10,padding:"5px 12px",flex:1,justifyContent:"center"})}}>💬 Open WhatsApp & Send</button>
            <button onClick={()=>setStep("idle")} style={{fontSize:10,color:SM.muted,background:"none",border:"none",cursor:"pointer"}}>✕</button>
          </div>
        </div>
      )}
    </div>
...
// ── ENHANCED CUSTOM CAMPAIGN ──────────────────────────────────────────────────
function EnhancedCustomCampaign({industry, onSent}){
  const[ctx,setCtx]=useState("");
  const[step,setStep]=useState("idle");
  const[msg,setMsg]=useState("");
  ...
  const send=()=>{
    window.open(`https://wa.me/?text=${encodeURIComponent(msg)}`,"_blank");
    if(onSent) onSent({label:ctx.slice(0,40)+"...",message:msg});
    setStep("done");
  };
  ...
  return(
    <div>
      {(step==="idle"||step==="generating")&&(
        <div style={{display:"flex",gap:6}}>
          <input value={ctx} onChange={e=>setCtx(e.target.value)} onKeyDown={e=>e.key==="Enter"&&generate()} placeholder="Describe your campaign..." style={{flex:1,background:SM.bg,border:`1px solid ${SM.border}`,borderRadius:6,padding:"6px 9px",fontSize:10,color:SM.text,outline:"none",fontFamily:"inherit"}}/>
          <button onClick={generate} disabled={!ctx.trim()||step==="generating"} style={{...sbtn("#25D166",{fontSize:10,padding:"6px 12px",opacity:!ctx.trim()||step==="generating"?0.5:1})}}>
            {step==="generating"?"...":"Go"}
          </button>
        </div>
      )}
      {step==="edit"&&(
        <div>
          <textarea value={msg} onChange={e=>setMsg(e.target.value)} rows={3} style={{width:"100%",background:SM.bg,border:"1px solid rgba(37,209,102,0.3)",borderRadius:5,padding:"7px 9px",fontSize:10,color:SM.text,outline:"none",resize:"none",fontFamily:"inherit",lineHeight:1.5,marginBottom:5}}/>
          <div style={{display:"flex",gap:6}}>
            <button onClick={send} style={{...sbtn("#25D166",{fontSize:10,padding:"5px 12px",flex:1,justifyContent:"center"})}}>💬 Open WhatsApp & Send</button>
            <button onClick={()=>setStep("idle")} style={{fontSize:10,color:SM.muted,background:"none",border:"none",cursor:"pointer"}}>✕</button>
          </div>
      ...
      {step==="done"&&<div style={{fontSize:9,color:SM.green,fontFamily:"'JetBrains Mono',monospace",marginTop:3}}>✓ Sent · Appears in Campaign Results to log outcomes</div>}
    </div>
  );
}


function SmeDashboard({industry, setPage, onExecute, onCampaignLog}){
  ...
  return(
    <div style={{flex:1,overflowY:"auto",padding:20,background:SM.bg,display:"flex",flexDirection:"column",gap:14}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 340px",gap:14,alignItems:"start"}}>
        ...
        {/* RIGHT: Customer Sales Engagement */}
        <CustomerSalesEngagement industry={industry} onCampaignLog={onCampaignLog}/>
      </div>
...
// ── SME ROI TRACKER — split into small components to avoid esbuild parser limits ──

function SmeCheckinBanner({pendingCheckin,industry,loggingId,setLoggingId}){
  if(!pendingCheckin||pendingCheckin.length===0) return null;
  return(
    <div style={{background:SM.amber+"25",border:"1.5px solid "+SM.amber+"50",borderRadius:10,padding:"12px 16px",display:"flex",gap:12,alignItems:"flex-start"}}>
      <span style={{fontSize:20,flexShrink:0}}>⏰</span>
      <div style={{flex:1}}>
        <div style={{fontSize:12,fontWeight:700,color:SM.amber,marginBottom:3}}>{pendingCheckin.length} initiative{pendingCheckin.length!==1?"s":""} need{pendingCheckin.length===1?"s":""} a results check-in</div>
        <div style={{fontSize:11,color:SM.muted,lineHeight:1.5,marginBottom:8}}>Log actual impact below. This helps Aether learn and improve future estimates for your business.</div>
        <div style={{display:"flex",gap:6,flexWrap:"wrap"}}>
          {pendingCheckin.slice(0,3).map(item=>(
            <button key={item.id} onClick={()=>setLoggingId(loggingId===item.id?null:item.id)} style={{...sbtn(SM.amber,{fontSize:10,padding:"4px 10px",background:SM.amber+"20",color:SM.amber,border:"1px solid "+SM.amber+"40"})}}>
              {(item.action||"Initiative").slice(0,28)}... →
            </button>
          ))}
        </div>
      </div>
...
function SmeValueHeader({industry,thisTotal,momDelta,allItems,executedItems,prevTotal,fee}){
  return(
    <div style={{background:"#080c18",border:"1px solid "+SM.border,borderRadius:10,padding:20,position:"relative",overflow:"hidden"}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:16}}>
        <div>
          <div style={{fontSize:26,fontWeight:900,color:"#34d399",letterSpacing:-1,fontFamily:"'JetBrains Mono',monospace"}}>{industry.currency}{thisTotal.toLocaleString()}</div>
          <div style={{fontSize:10,color:"rgba(255,255,255,0.5)",marginTop:2}}>Total value identified</div>
          <div style={{fontSize:9,color:momDelta>=0?"#34d399":"#f87171",marginTop:3,fontFamily:"'JetBrains Mono',monospace"}}>{momDelta>=0?"▲":"▼"} {industry.currency}{Math.abs(momDelta).toLocaleString()} vs last month</div>
        </div>
        <div>
          <div style={{fontSize:26,fontWeight:900,color:"#60a5fa",letterSpacing:-1,fontFamily:"'JetBrains Mono',monospace"}}>{Math.max(0,Math.round(thisTotal/fee))}x</div>
          <div style={{fontSize:10,color:"rgba(255,255,255,0.5)",marginTop:2}}>Return on subscription</div>
          <div style={{fontSize:9,color:"rgba(255,255,255,0.3)",marginTop:3}}>{industry.currency}{fee}/month plan</div>
        </div>
        <div>
          <div style={{fontSize:26,fontWeight:900,color:"#f9a8d4",letterSpacing:-1,fontFamily:"'JetBrains Mono',monospace"}}>{allItems.length}</div>
          <div style={{fontSize:10,color:"rgba(255,255,255,0.5)",marginTop:2}}>Decisions tracked</div>
          <div style={{fontSize:9,color:"rgba(255,255,255,0.3)",marginTop:3}}>{executedItems.filter(i=>i.actualValue).length} with actual results logged</div>
        </div>
        <div>
          <div style={{fontSize:26,fontWeight:900,color:SM.amber,letterSpacing:-1,fontFamily:"'JetBrains Mono',monospace"}}>{industry.currency}{prevTotal.toLocaleString()}</div>
          <div style={{fontSize:10,color:"rgba(255,255,255,0.5)",marginTop:2}}>Previous month total</div>
          <div style={{fontSize:9,color:"rgba(255,255,255,0.3)",marginTop:3}}>Baseline comparison</div>
        </div>
      </div>
    </div>
  );
...
function SmeMomCard({industry,allItems,thisTotal,prevTotal,momDelta}){
  return(
    <div style={scard()}>
      <div style={{fontSize:12,fontWeight:800,color:SM.text,marginBottom:12}}>Month-on-Month Outcome Comparison</div>
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:12}}>
        {[{label:"This Month",val:thisTotal,c:industry.color,sub:allItems.length+" decisions tracked"},{label:"Last Month",val:prevTotal,c:SM.muted,sub:industry.roiItems.length+" decisions tracked"}].map(col=>(
          <div key={col.label} style={{background:SM.bgSec,borderRadius:8,padding:"12px 14px",border:"1px solid "+SM.border}}>
            <div style={{fontSize:9,color:SM.muted,letterSpacing:1,textTransform:"uppercase",fontFamily:"'JetBrains Mono',monospace",marginBottom:5}}>{col.label}</div>
            ...
            <div style={{fontSize:10,color:SM.dim,marginTop:2}}>{col.sub}</div>
          </div>
        ))}
      </div>
      <div style={{background:momDelta>=0?SM.greenLight:SM.redLight,borderRadius:7,padding:"10px 14px"}}>
        ...
        <span style={{fontSize:11,color:SM.muted}}>{momDelta>=0?"improvement":"decline"} month-on-month</span>
      </div>
    </div>
  );
}

function SmeDecisionRow({r,i,industry,loggingId,setLoggingId,actualInputs,setActualInputs,submitActual}){
  const tc=r.type==="revenue"?SM.green:r.type==="saved"?"#06b6d4":r.type==="protected"?SM.purple:SM.amber;
  const tl=r.type==="revenue"?"REVENUE":r.type==="saved"?"COST SAVED":r.type==="protected"?"PROTECTED":"RECOVERED";
  const hasActual=!!r.actualValue;
  const estNum=toNum(r.estimatedValue||r.value||"0");
  const actNum=hasActual?toNum(r.actualValue||"0"):null;
  const variance=actNum&&estNum?((actNum-estNum)/estNum*100).toFixed(0):null;
  const isLogging=loggingId===r.id;
  return(
    <div key={i} style={{background:SM.bgSec,borderRadius:8,border:"1px solid "+(hasActual?SM.green:SM.border),overflow:"hidden"}}>
      <div style={{padding:"10px 12px",display:"flex",alignItems:"flex-start",gap:10}}>
        <div style={{width:34,height:34,borderRadius:7,background:tc+"20",border:"1px solid "+tc+"35",display:"flex",alignItems:"center",justifyContent:"center",fontSize:14,flexShrink:0}}>
          {r.type==="revenue"?"📈":r.type==="saved"?"💰":r.type==="protected"?"🛡":"♻️"}
        </div>
        <div style={{flex:1}}>
          <div style={{fontSize:11,fontWeight:600,color:SM.text,marginBottom:4}}>{r.action||r.q}</div>
          <div style={{display:"flex",gap:5,flexWrap:"wrap",marginBottom:6}}>
            <STag c={tc}>{tl}</STag>
            {!hasActual&&r.executedAt?<STag c={SM.amber}>AWAITING RESULTS</STag>:null}
            {hasActual?<STag c={SM.green}>✓ LOGGED</STag>:null}
          </div>
          {(hasActual||r.estimatedValue||r.value)?(
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:6,marginTop:4}}>
              <div style={{background:SM.bgCard,borderRadius:5,padding:"5px 8px"}}>
                <div style={{fontSize:8,color:SM.muted,letterSpacing:1,fontFamily:"'JetBrains Mono',monospace",marginBottom:1}}>ESTIMATED</div>
                <div style={{fontSize:12,fontWeight:700,color:SM.muted}}>{r.estimatedValue||r.value}</div>
              </div>
              <div style={{background:hasActual?SM.green+"18":SM.bgCard,borderRadius:5,padding:"5px 8px",border:hasActual?"1px solid "+SM.green+"35":"none"}}>
                <div style={{fontSize:8,color:SM.muted,letterSpacing:1,fontFamily:"'JetBrains Mono',monospace",marginBottom:1}}>ACTUAL</div>
                {hasActual?<div style={{fontSize:12,fontWeight:800,color:SM.green}}>{r.actualValue}</div>:<div style={{fontSize:9,color:SM.dim,fontStyle:"italic"}}>Not logged</div>}
              </div>
              <div style={{background:SM.bgCard,borderRadius:5,padding:"5px 8px"}}>
                <div style={{fontSize:8,color:SM.muted,letterSpacing:1,fontFamily:"'JetBrains Mono',monospace",marginBottom:1}}>VARIANCE</div>
                {variance!=null?<div style={{fontSize:12,fontWeight:800,color:parseFloat(variance)>=0?SM.green:SM.red}}>{parseFloat(variance)>=0?"+":""}{variance}%</div>:<div style={{fontSize:9,color:SM.dim}}>—</div>}
              </div>
            </div>
          ):null}
        </div>
        {!hasActual&&r.executedAt?(
          <button onClick={()=>setLoggingId(isLogging?null:r.id)} style={{...sbtn(isLogging?SM.muted:industry.color,{fontSize:9,padding:"5px 9px",flexShrink:0,background:isLogging?SM.bgCard:industry.color,border:"1px solid "+industry.color+"40",color:isLogging?SM.muted:"#fff"})}}>
            {isLogging?"▲ Close":"Log Actual"}
          </button>
        ):null}
      </div>
      {isLogging?(
        <div style={{padding:"10px 12px",background:industry.color+"10",borderTop:"1px solid "+SM.border}}>
          <div style={{fontSize:9,fontWeight:700,color:industry.color,letterSpacing:1,fontFamily:"'JetBrains Mono',monospace",marginBottom:6}}>LOG ACTUAL IMPACT</div>
          <div style={{display:"flex",gap:8,alignItems:"flex-end"}}>
            <div style={{flex:1}}>
              <div style={{fontSize:9,color:SM.muted,marginBottom:3}}>Actual value ({industry.currency})</div>
              <input value={actualInputs[r.id]||""} onChange={e=>setActualInputs(p=>({...p,[r.id]:e.target.value}))} onKeyDown={e=>e.key==="Enter"&&submitActual(r)} placeholder={"e.g. "+(r.estimatedValue||r.value||"").split("").filter(c=>"0123456789.,".includes(c)).join("")} style={{width:"100%",background:SM.bgCard,border:"1px solid "+SM.border,borderRadius:5,padding:"6px 8px",fontSize:11,color:SM.text,outline:"none",fontFamily:"inherit"}}/>
            </div>
            <button onClick={()=>submitActual(r)} disabled={!(actualInputs[r.id]||"").trim()} style={{...sbtn(industry.color,{fontSize:10,padding:"7px 14px",flexShrink:0,opacity:!(actualInputs[r.id]||"").trim()?0.4:1})}}>Save</button>
          </div>
        </div>
      ):null}
    </div>
...
function SmeDecisionsCard({industry,allItems,loggingId,setLoggingId,actualInputs,setActualInputs,submitActual}){
  return(
    <div style={scard()}>
      <div style={{fontSize:12,fontWeight:800,color:SM.text,marginBottom:12}}>Decision Outcomes — Estimated vs Actual</div>
      {allItems.length===0?<div style={{fontSize:11,color:SM.muted,textAlign:"center",padding:"20px 0"}}>No initiatives executed yet. Go to Dashboard and click Execute on any decision.</div>:null}
      <div style={{display:"flex",flexDirection:"column",gap:8}}>
        {allItems.map((r,i)=><SmeDecisionRow key={i} r={r} i={i} industry={industry} loggingId={loggingId} setLoggingId={setLoggingId} actualInputs={actualInputs} setActualInputs={setActualInputs} submitActual={submitActual}/>)}
      </div>
    </div>
  );
}

function SmeLearningsCard({learnings}){
  if(!learnings||learnings.length===0) return null;
  return(
    <div style={{...scard(),border:"1.5px solid "+SM.purple+"35",background:SM.purple+"0A"}}>
      <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:12}}>
        <span style={{fontSize:18}}>🧠</span>
        <div>
          <div style={{fontSize:12,fontWeight:800,color:SM.purple}}>Aether Platform Learning</div>
          <div style={{fontSize:10,color:SM.muted}}>Estimates adjusted based on your actual results</div>
        </div>
        <STag c={SM.purple}>{learnings.length} INSIGHT{learnings.length!==1?"S":""}</STag>
      </div>
      <div style={{display:"flex",flexDirection:"column",gap:8}}>
        {learnings.map((l,i)=>(
          <div key={i} style={{background:SM.bgCard,borderRadius:8,padding:"10px 14px",border:"1px solid "+SM.purple+"22"}}>
            <div style={{display:"flex",gap:8,alignItems:"flex-start"}}>
              <span style={{fontSize:14,flexShrink:0}}>{l.dir==="outperformed"?"📈":"📉"}</span>
              <div style={{flex:1}}>
                <div style={{fontSize:11,fontWeight:600,color:SM.text,marginBottom:4}}>{l.initiative}</div>
                <div style={{fontSize:10,color:SM.muted,lineHeight:1.6,marginBottom:6}}>{l.learning}</div>
                <div style={{display:"flex",gap:8,flexWrap:"wrap",alignItems:"center"}}>
                  <div style={{background:SM.bgSec,borderRadius:4,padding:"3px 8px"}}><span style={{fontSize:9,color:SM.muted}}>Was: </span><span style={{fontSize:10,fontWeight:700,color:SM.muted,textDecoration:"line-through"}}>{l.estimated}</span></div>
                  <span style={{color:SM.muted}}>→</span>
                  <div style={{background:SM.purple+"18",borderRadius:4,padding:"3px 8px"}}><span style={{fontSize:9,color:SM.purple}}>Now: </span><span style={{fontSize:10,fontWeight:800,color:SM.purple}}>{l.adjustedEstimate}</span></div>
                  <STag c={l.dir==="outperformed"?SM.green:SM.amber}>{l.ratio}x actual vs estimated</STag>
                </div>
              </div>
            </div>
          </div>
...
function SmeCampaignsCard({industry,campaigns}){
  if(!campaigns||campaigns.length===0) return null;
  return(
    <div style={scard()}>
      <div style={{fontSize:12,fontWeight:800,color:SM.text,marginBottom:10}}>Customer Engagement — Campaign Summary</div>
      <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:10,marginBottom:10}}>
        {[
          {l:"Campaigns sent",v:campaigns.length,c:industry.color},
          {l:"Total link clicks",v:campaigns.reduce((s,c)=>s+(c.clicks||0),0),c:SM.accent},
          {l:"Revenue tracked",v:industry.currency+campaigns.filter(c=>c.revenue).reduce((s,c)=>s+parseFloat(c.revenue||"0"),0).toLocaleString(),c:SM.green},
        ].map(m=>(
          <div key={m.l} style={{background:SM.bgSec,borderRadius:7,padding:"10px 12px",textAlign:"center"}}>
            <div style={{fontSize:20,fontWeight:800,color:m.c,fontFamily:"'JetBrains Mono',monospace"}}>{m.v}</div>
            <div style={{fontSize:9,color:SM.muted,marginTop:2}}>{m.l}</div>
          </div>
        ))}
      </div>
      {campaigns.filter(c=>c.status==="tracked").map((c,i)=>(
        <div key={i} style={{display:"flex",gap:10,alignItems:"center",padding:"7px 10px",background:SM.bgSec,borderRadius:6,marginBottom:4}}>
          <span style={{fontSize:11}}>💬</span>
          <div style={{flex:1}}>
            <div style={{fontSize:10,fontWeight:600,color:SM.text}}>{c.label}</div>
            <div style={{fontSize:9,color:SM.muted}}>{c.sentAt}</div>
          </div>
          <div style={{display:"flex",gap:5,flexWrap:"wrap",justifyContent:"flex-end"}}>
            {c.clicks>0?<STag c={SM.accent}>{c.clicks} clicks</STag>:null}
            {c.replies!=null?<STag c="#25D166">{c.replies} replies</STag>:null}
            {c.bookings!=null?<STag c={SM.green}>{c.bookings} bookings</STag>:null}
            {c.revenue?<STag c={SM.green}>{industry.currency}{c.revenue}</STag>:null}
          </div>
        </div>
      ))}
    </div>
...
function SmeROITracker({industry, executedItems=[], onActualLogged, learnings=[], campaigns=[]}){
  const STORAGE_KEY  = 'aether_sme_expenses_'+industry.id;
  const SNAPSHOT_KEY = 'aether_sme_snapshots_'+industry.id;
  ...
  const[snapshots,setSnapshots]=useState(()=>{
    try{ const s=localStorage.getItem(SNAPSHOT_KEY); return s?JSON.parse(s):[]; }catch(e){ return []; }
  });
  const[activeMonth,setActiveMonth]=useState(new Date().toISOString().slice(0,7));
  const[expInput,setExpInput]=useState(""); const[expAmount,setExpAmount]=useState("");
  const[expCat,setExpCat]=useState("staffcost"); const[expDate,setExpDate]=useState(new Date().toISOString().slice(0,10));
  const[expNote,setExpNote]=useState(""); const[closingMonth,setClosingMonth]=useState(false);

  const CATS=[
    {id:"staffcost",   label:"Staff Costs / CPF",          ded:100, color:SM.accent},
    {id:"rent",        label:"Rent & Utilities",            ded:100, color:SM.purple},
    {id:"marketing",   label:"Marketing & Advertising",    ded:100, color:SM.green},
    {id:"cogs",        label:"Cost of Goods / Consumables",ded:100, color:SM.amber},
    {id:"professional",label:"Professional Services",      ded:100, color:SM.blue||"#3b82f6"},
    {id:"equipment",   label:"Equipment & Maintenance",    ded:100, color:SM.muted},
    {id:"entertainment",label:"Client Entertainment",      ded:50,  color:SM.red},
    {id:"other",       label:"Other Operating",            ded:100, color:SM.dim},
  ];
  const catMap=Object.fromEntries(CATS.map(c=>[c.id,c]));

  // ── Derived values ────────────────────────────────────────────────────────
  const prevTotal=industry.roiItems.reduce((s,r)=>s+toNum(r.prevMonth||"0"),0);
  const thisTotal=allItems.reduce((s,r)=>s+toNum(r.actualValue||r.value||"0"),0);
  const momDelta=thisTotal-prevTotal;
  const fee=449;
  const pendingCheckin=executedItems.filter(i=>!i.actualValue);
  const monthExps=allExpenses.filter(e=>e.date&&e.date.slice(0,7)===activeMonth);
  const ytdExps=allExpenses.filter(e=>e.date&&e.date.startsWith(activeMonth.slice(0,4)));
  const totalMonth=monthExps.reduce((s,e)=>s+(e.amount||0),0);
  const totalYTD=ytdExps.reduce((s,e)=>s+(e.amount||0),0);
  const deductYTD=ytdExps.reduce((s,e)=>s+(e.amount||0)*(catMap[e.cat]?.ded||100)/100,0);

  const monthsWithData=[...new Set(allExpenses.filter(e=>e.date).map(e=>e.date.slice(0,7)))].sort().reverse();
  if(!monthsWithData.includes(activeMonth)) monthsWithData.unshift(activeMonth);
  const fmtMonth=(ym)=>{ try{ const[y,mo]=ym.split("-"); return new Date(+y,+mo-1).toLocaleDateString("en-SG",{month:"short",year:"numeric"}); }catch(e){ return ym; } };

  // ── Handlers ──────────────────────────────────────────────────────────────
  const saveExpenses=(exps)=>{
    setAllExpenses(exps);
    try{ localStorage.setItem(STORAGE_KEY,JSON.stringify(exps)); }catch(e){}
  };
  const saveSnapshots=(snaps)=>{
    setSnapshots(snaps);
    try{ localStorage.setItem(SNAPSHOT_KEY,JSON.stringify(snaps)); }catch(e){}
  };
  const submitActual=(item)=>{
    const val=(actualInputs[item.id]||"").trim(); if(!val) return;
    const fmt=val.startsWith(industry.currency)?val:industry.currency+val;
    if(onActualLogged) onActualLogged(item.id,fmt,"");
    setLoggingId(null); setActualInputs(p=>({...p,[item.id]:""}));
  };
  const addExpense=()=>{
    if(!expInput.trim()||!expAmount) return;
    const e={id:"e-"+Date.now(),label:expInput.trim(),amount:parseFloat(expAmount)||0,cat:expCat,date:expDate,note:expNote.trim()};
    saveExpenses([...allExpenses,e]);
    setExpInput(""); setExpAmount(""); setExpNote(""); setExpCat("staffcost");
  };
  const exportCSV=()=>{
    const year=activeMonth.slice(0,4);
    const rows=["Date,Description,Category,Amount,Deductible %,Notes"];
    ytdExps.sort((a,b)=>(a.date||"").localeCompare(b.date||"")).forEach(e=>{
      const cat=catMap[e.cat];
      rows.push(e.date+',"'+e.label+'","'+(cat?cat.label:e.cat)+'",'+e.amount+','+(cat?cat.ded:100)+'%,"'+(e.note||"")+'"');
    });
    rows.push(""); rows.push('"YTD Total",,,'+totalYTD.toFixed(2)+',,');
    rows.push('"Estimated Deductible YTD",,,'+deductYTD.toFixed(2)+',,');
    rows.push('"","For reference only — consult a tax professional for your filing",,,,');
    const blob=new Blob([rows.join("\\n")],{type:"text/csv"});
    const url=URL.createObjectURL(blob);
    const a=document.createElement("a");
    a.href=url; a.download=year+"_Expenses_"+industry.bizName.split(" ").join("_")+".csv";
    a.click(); URL.revokeObjectURL(url);
  };
  const closeMonth=async()=>{
    setClosingMonth(true);
    const sys="You are Aether SME — business analyst for "+industry.bizName+". Write a concise monthly review in 3 sections with bold headers: **Revenue & Decisions**, **Expenses & Profitability**, **Priority for Next Month**. Max 180 words. Be specific with numbers.";
    const ctx="Month: "+fmtMonth(activeMonth)+"\\nDecisions: "+executedItems.length+" executed, value "+industry.currency+thisTotal.toLocaleString()+" ("+( momDelta>=0?"+":"-")+industry.currency+Math.abs(momDelta).toLocaleString()+" MoM)\\nExpenses: "+industry.currency+totalMonth.toLocaleString()+"\\nBreakdown: "+CATS.map(c=>{const t=monthExps.filter(e=>e.cat===c.id).reduce((s,e)=>s+e.amount,0);return t>0?c.label+": "+industry.currency+t:null;}).filter(Boolean).join(", ");
    let summary="";
    try{ const r=await callClaude([{role:"user",content:ctx}],sys,false,"snap"); summary=r.text; }
    catch(e){ summary="**Revenue & Decisions**\\n"+executedItems.length+" decisions · "+industry.currency+thisTotal.toLocaleString()+" tracked\\n\\n**Expenses**\\n"+industry.currency+totalMonth.toLocaleString()+"\\n\\n**Next Month**\\nAdd VITE_ANTHROPIC_KEY to generate AI review."; }
    const snap={id:activeMonth,label:fmtMonth(activeMonth),summary,decisionsExecuted:executedItems.length,valueTracked:thisTotal,expenses:totalMonth,momDelta,closedAt:new Date().toISOString()};
    saveSnapshots([...snapshots.filter(s=>s.id!==activeMonth),snap].sort((a,b)=>b.id.localeCompare(a.id)));
    setClosingMonth(false);
  };
  const thisSnap=snapshots.find(s=>s.id===activeMonth);

  // ── Render ────────────────────────────────────────────────────────────────
  return(
    <div style={{flex:1,overflowY:"auto",padding:20,background:SM.bg,display:"flex",flexDirection:"column",gap:14}}>
      {/* Tab switcher */}
      <div style={{display:"flex",gap:4,background:SM.bgCard,borderRadius:8,padding:4,width:"fit-content",border:"1px solid "+SM.border}}>
        {[{id:"roi",label:"ROI Tracker"},{id:"expenses",label:"💰 Expenses & Tax"},{id:"review",label:"📋 Monthly Reviews"}].map(t=>(
          <button key={t.id} onClick={()=>setActiveTab(t.id)} style={{fontSize:11,padding:"6px 14px",borderRadius:6,border:"none",cursor:"pointer",fontFamily:"inherit",fontWeight:activeTab===t.id?700:400,background:activeTab===t.id?industry.color:"transparent",color:activeTab===t.id?"#fff":SM.muted,transition:"all 0.15s"}}>
            {t.label}
          </button>
        ))}
      </div>
      ...
      {activeTab==="roi" ? (
        <div style={{display:"flex",flexDirection:"column",gap:14}}>
          <SmeCheckinBanner pendingCheckin={pendingCheckin} industry={industry} loggingId={loggingId} setLoggingId={setLoggingId}/>
          <SmeValueHeader industry={industry} thisTotal={thisTotal} momDelta={momDelta} allItems={allItems} executedItems={executedItems} prevTotal={prevTotal} fee={fee}/>
          <SmeMomCard industry={industry} allItems={allItems} thisTotal={thisTotal} prevTotal={prevTotal} momDelta={momDelta}/>
          <SmeDecisionsCard industry={industry} allItems={allItems} loggingId={loggingId} setLoggingId={setLoggingId} actualInputs={actualInputs} setActualInputs={setActualInputs} submitActual={submitActual}/>
          <SmeLearningsCard learnings={learnings}/>
          <SmeCampaignsCard industry={industry} campaigns={campaigns}/>
        </div>
      ) : null}
      ...
      {activeTab==="expenses" ? (
        <div style={{display:"flex",flexDirection:"column",gap:14}}>
          ...
          <div style={{display:"flex",gap:8,alignItems:"center",flexWrap:"wrap"}}>
            <span style={{fontSize:10,color:SM.muted,fontFamily:"'JetBrains Mono',monospace",letterSpacing:1}}>MONTH:</span>
            {monthsWithData.slice(0,6).map(m=>(
              <button key={m} onClick={()=>setActiveMonth(m)} style={{fontSize:11,padding:"4px 12px",borderRadius:20,border:"1.5px solid "+(activeMonth===m?industry.color:SM.border),background:activeMonth===m?industry.color+"18":"transparent",color:activeMonth===m?industry.color:SM.muted,cursor:"pointer",fontFamily:"inherit",fontWeight:activeMonth===m?700:400}}>
                {fmtMonth(m)}
              </button>
            ))}
            <button onClick={exportCSV} style={{...sbtn(SM.green,{fontSize:10,padding:"5px 12px",marginLeft:"auto"})}}>↓ Export CSV {activeMonth.slice(0,4)}</button>
          </div>

          {/* YTD dark header */}
          <div style={{background:"#080c18",border:"1px solid "+SM.border,borderRadius:10,padding:16}}>
            <div style={{fontSize:9,color:"rgba(255,255,255,0.4)",letterSpacing:2,textTransform:"uppercase",fontFamily:"'JetBrains Mono',monospace",marginBottom:10}}>YTD Summary — {activeMonth.slice(0,4)}</div>
            <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:12}}>
              <div><div style={{fontSize:20,fontWeight:900,color:"#f87171",fontFamily:"'JetBrains Mono',monospace"}}>{industry.currency}{totalYTD.toLocaleString()}</div><div style={{fontSize:9,color:"rgba(255,255,255,0.4)",marginTop:2}}>Total YTD Spend</div></div>
              <div><div style={{fontSize:20,fontWeight:900,color:"#34d399",fontFamily:"'JetBrains Mono',monospace"}}>{industry.currency}{deductYTD.toFixed(0)}</div><div style={{fontSize:9,color:"rgba(255,255,255,0.4)",marginTop:2}}>Est. Deductible YTD</div></div>
              <div><div style={{fontSize:20,fontWeight:900,color:"#60a5fa",fontFamily:"'JetBrains Mono',monospace"}}>{industry.currency}{totalMonth.toLocaleString()}</div><div style={{fontSize:9,color:"rgba(255,255,255,0.4)",marginTop:2}}>This Month ({fmtMonth(activeMonth)})</div></div>
            </div>
          </div>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:14,alignItems:"start"}}>
            ...
            {/* Logger */}
            <div style={scard()}>
              <div style={{fontSize:12,fontWeight:800,color:SM.text,marginBottom:2}}>Log Expense</div>
              <div style={{fontSize:10,color:SM.muted,marginBottom:10}}>Saved permanently · CSV export for tax filing</div>
              <div style={{display:"flex",flexDirection:"column",gap:6}}>
                <input value={expInput} onChange={e=>setExpInput(e.target.value)} placeholder="Description" style={{background:SM.bgSec,border:"1px solid "+SM.border,borderRadius:5,padding:"6px 9px",fontSize:11,color:SM.text,outline:"none",fontFamily:"inherit"}}/>
                <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:6}}>
                  <input value={expAmount} onChange={e=>setExpAmount(e.target.value)} placeholder={"Amount ("+industry.currency+")"} type="number" style={{background:SM.bgSec,border:"1px solid "+SM.border,borderRadius:5,padding:"6px 9px",fontSize:11,color:SM.text,outline:"none",fontFamily:"inherit"}}/>
                  <input value={expDate} onChange={e=>setExpDate(e.target.value)} type="date" style={{background:SM.bgSec,border:"1px solid "+SM.border,borderRadius:5,padding:"6px 9px",fontSize:11,color:SM.text,outline:"none",fontFamily:"inherit"}}/>
                </div>
                <select value={expCat} onChange={e=>setExpCat(e.target.value)} style={{background:SM.bgSec,border:"1px solid "+SM.border,borderRadius:5,padding:"6px 9px",fontSize:11,color:SM.text,fontFamily:"inherit",cursor:"pointer"}}>
                  {CATS.map(c=><option key={c.id} value={c.id}>{c.label}{c.ded===50?" (50% deductible)":""}</option>)}
                </select>
                <input value={expNote} onChange={e=>setExpNote(e.target.value)} placeholder="Notes (optional)" style={{background:SM.bgSec,border:"1px solid "+SM.border,borderRadius:5,padding:"6px 9px",fontSize:11,color:SM.text,outline:"none",fontFamily:"inherit"}}/>
                <button onClick={addExpense} disabled={!expInput.trim()||!expAmount} style={{...sbtn(industry.color,{fontSize:11,justifyContent:"center",opacity:!expInput.trim()||!expAmount?0.4:1})}}>+ Add Expense</button>
              </div>
              <div style={{fontSize:8.5,color:SM.dim,marginTop:8,fontStyle:"italic",textAlign:"center"}}>For reference only — consult a tax professional for your actual filing</div>
            </div>

            {/* Entries */}
            <div style={scard()}>
              <div style={{fontSize:12,fontWeight:800,color:SM.text,marginBottom:10}}>Expenses — {fmtMonth(activeMonth)}</div>
              {monthExps.length===0&&<div style={{fontSize:10,color:SM.dim,textAlign:"center",padding:"16px 0",fontStyle:"italic"}}>No expenses logged for {fmtMonth(activeMonth)}</div>}
              <div style={{display:"flex",flexDirection:"column",gap:4,maxHeight:300,overflowY:"auto"}}>
                {monthExps.sort((a,b)=>(b.date||"").localeCompare(a.date||"")).map(e=>{
                  const cat=catMap[e.cat];
                  return(
                    <div key={e.id} style={{display:"flex",gap:7,alignItems:"center",background:SM.bgSec,borderRadius:5,padding:"5px 9px"}}>
                      <span style={{fontSize:7.5,padding:"2px 5px",borderRadius:3,background:(cat?.color||SM.dim)+"18",color:cat?.color||SM.dim,fontFamily:"'JetBrains Mono',monospace",fontWeight:700,flexShrink:0,whiteSpace:"nowrap"}}>{(cat?.label||e.cat).split(" ")[0].toUpperCase()}</span>
                      <div style={{flex:1,minWidth:0}}>
                        <div style={{fontSize:10,color:SM.text,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{e.label}</div>
                        <div style={{fontSize:8.5,color:SM.dim}}>{e.date}{cat?.ded===50?" · 50% ded":""}</div>
                      </div>
                      <span style={{fontSize:11,fontWeight:700,color:SM.red,fontFamily:"'JetBrains Mono',monospace",flexShrink:0}}>{industry.currency}{e.amount}</span>
                      <button onClick={()=>saveExpenses(allExpenses.filter(x=>x.id!==e.id))} style={{fontSize:13,color:SM.dim,background:"none",border:"none",cursor:"pointer",flexShrink:0,lineHeight:1}}>×</button>
                    </div>
                  );
                })}
              </div>
              {monthExps.length>0 ? (
                <div style={{marginTop:8,padding:"7px 10px",background:SM.bgSec,borderRadius:5,display:"flex",justifyContent:"space-between"}}>
                  <span style={{fontSize:10,color:SM.muted}}>Month total</span>
                  <span style={{fontSize:11,fontWeight:700,color:SM.red,fontFamily:"'JetBrains Mono',monospace"}}>{industry.currency}{totalMonth.toLocaleString()}</span>
                </div>
              ) : null}
            </div>
      ...
      {activeTab==="review" ? (
        <div style={{display:"flex",flexDirection:"column",gap:14}}>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
            <div>
              <div style={{fontSize:13,fontWeight:800,color:SM.text}}>Monthly Business Reviews</div>
              <div style={{fontSize:11,color:SM.muted}}>Close each month to generate a permanent AI-written business review</div>
            </div>
            <button onClick={closeMonth} disabled={closingMonth||!!thisSnap} style={{...sbtn(industry.color,{fontSize:10,padding:"7px 14px",opacity:closingMonth||thisSnap?0.5:1})}}>
              {closingMonth?"Generating...":(thisSnap?"✓ "+fmtMonth(activeMonth)+" Closed":"Close "+fmtMonth(activeMonth))}
            </button>
          </div>
          {snapshots.length===0 ? (
            <div style={{...scard(),textAlign:"center",padding:"32px 20px"}}>
              <div style={{fontSize:28,marginBottom:10}}>📋</div>
              <div style={{fontSize:13,fontWeight:700,color:SM.text,marginBottom:6}}>No monthly reviews yet</div>
              <div style={{fontSize:11,color:SM.muted,lineHeight:1.6}}>Click "Close {fmtMonth(activeMonth)}" to generate your first monthly business review. Aether will analyse your decisions, ROI, and expenses.</div>
            </div>
          ) : null}
          {snapshots.map(snap=>(
            <div key={snap.id} style={{...scard(),border:"1px solid "+industry.color+"35"}}>
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:10,paddingBottom:10,borderBottom:"1px solid "+SM.border}}>
                <div style={{fontSize:13,fontWeight:800,color:industry.color}}>{snap.label}</div>
                <div style={{display:"flex",gap:8,alignItems:"center"}}>
                  {snap.decisionsExecuted>0&&<span style={{fontSize:10,color:SM.muted}}>{snap.decisionsExecuted} decisions</span>}
                  <STag c={SM.green}>{industry.currency}{(snap.valueTracked||0).toLocaleString()}</STag>
                  {snap.expenses>0&&<STag c={SM.red}>−{industry.currency}{snap.expenses.toLocaleString()}</STag>}
                  <STag c={snap.momDelta>=0?SM.green:SM.red}>{snap.momDelta>=0?"▲":"▼"} MoM</STag>
                </div>
              </div>
              <div style={{fontSize:10.5,color:SM.muted,lineHeight:1.75}}><Md text={snap.summary}/></div>
              {snap.closedAt&&<div style={{fontSize:8.5,color:SM.dim,marginTop:8}}>Closed {new Date(snap.closedAt).toLocaleDateString("en-SG",{day:"numeric",month:"short",year:"numeric"})}</div>}
            </div>
          ))}
        </div>
      ) : null}
...
const SME_NAV=[
  ...
  {id:"roi",      label:"ROI Tracker",     icon:"📊", badge:true},
];

// Numeric string helper — avoids regex-in-JSX esbuild issue
const toNum=(s,allowComma)=>{ if(!s) return 0; let r=""; for(const c of String(s)){ if("0123456789.".includes(c)||(allowComma&&c===",")) r+=c; } return parseFloat(r)||0; };
...
function SmeApp({onBack}){
  ...
  const[campaigns,setCampaigns]=useState([]);        // tracked campaigns + outcomes
  const[learnings,setLearnings]=useState([]);         // platform learning from actuals
  const[roiBadge,setRoiBadge]=useState(0);            // pending check-ins count

  const handleExecute=(item)=>{
    const newItem={
      ...item,
      id:item.id||`exec-${Date.now()}`,
      value:item.value||item.impact||"TBD",
      estimatedValue:item.value||item.impact||"TBD",
      actualValue:null,
      prevMonth:"S$0",
      executedAt:Date.now(),
      checkin7done:false,
    ...
    setExecutedItems(p=>[...p,newItem]);
    // Schedule badge after 7 days — in demo we surface it immediately with a button
    setRoiBadge(p=>p+1);
  };

  const handleCampaignLog=(campaign)=>{
    setCampaigns(p=>[...p,campaign]);
  };

  const handleActualLogged=(itemId, actualVal, note)=>{
    setExecutedItems(p=>p.map(i=>{
      if(i.id!==itemId) return i;
      const updated={...i,actualValue:actualVal,actualNote:note,actualLoggedAt:Date.now()};
      // Platform learning: if actual differs >20% from estimate, create a learning
      const est=toNum(i.estimatedValue||"0");
      const act=toNum(actualVal||"0");
      if(est>0 && act>0){
        const ratio=act/est;
        const diff=Math.abs(ratio-1);
        if(diff>0.15){
          const adj=Math.round(est*ratio);
          const cur=i.estimatedValue.replace(/[0-9,]+/,adj.toLocaleString());
          const dir=ratio>1?"outperformed":"underperformed";
          setLearnings(prev=>[...prev,{
            id:`learn-${Date.now()}`,
            category:i.cat||"revenue",
            initiative:i.action||i.q||"Initiative",
            estimated:i.estimatedValue,
            actual:actualVal,
            ratio:ratio.toFixed(2),
            learning:`${i.cat||"Revenue"} initiatives of this type ${dir} estimates by ${Math.round(diff*100)}%. Future estimates for similar decisions adjusted from ${i.estimatedValue} → ${cur}.`,
            adjustedEstimate:cur,
            dir,
            at:Date.now(),
          }]);
        }
    ...
    <div style={{display:"flex",height:"100vh",background:SM.bg,fontFamily:"'Inter',system-ui,sans-serif",color:SM.text,overflow:"hidden"}}>
      ...
      <aside style={{width:210,flexShrink:0,background:SM.bgCard,borderRight:`1px solid ${SM.border}`,display:"flex",flexDirection:"column",overflow:"hidden"}}>
        ...
        <nav style={{flex:1,padding:8,display:"flex",flexDirection:"column",gap:2}}>
          {SME_NAV.map(n=>(
            <button key={n.id} onClick={()=>setPage(n.id)} style={{display:"flex",alignItems:"center",gap:9,padding:"10px 12px",borderRadius:8,border:"none",cursor:"pointer",textAlign:"left",width:"100%",transition:"all 0.12s",background:page===n.id?`${industry.color}12`:"transparent",color:page===n.id?industry.color:SM.muted,fontWeight:page===n.id?700:400,fontSize:13,fontFamily:"inherit",position:"relative"}}>
              <span style={{fontSize:14}}>{n.icon}</span>
              {n.label}
              {n.badge&&roiBadge>0&&(
                <span style={{marginLeft:4,minWidth:16,height:16,borderRadius:8,background:SM.red,color:"#fff",fontSize:9,fontWeight:800,display:"inline-flex",alignItems:"center",justifyContent:"center",padding:"0 4px"}}>{roiBadge}</span>
              )}
      ...
      <main style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden"}}>
        ...
        <div style={{flex:1,overflow:"hidden",display:"flex"}}>
          {page==="dashboard"&&<SmeDashboard industry={industry} setPage={setPage} onExecute={handleExecute} onCampaignLog={handleCampaignLog}/>}
          {page==="copilot" &&<SmeCopilot  industry={industry}/>}
          {page==="roi"     &&<SmeROITracker industry={industry} executedItems={executedItems} onActualLogged={handleActualLogged} learnings={learnings} campaigns={campaigns}/>}
        </div>
      </main>
    </div>
  );
...
function LandingScreen({onSelect}){
  const modes=[
    ...
    {
      id:"solo", icon:"⚡", label:"Solo", badge:"INDIVIDUAL BUSINESS OWNER",
      tagline:"Sales intelligence for one", color:"#0D9488",
      features:["Realtor · Insurance/FA · Personal Business","Deal pipeline with heat scoring","WhatsApp message generator — opens directly in your app","Calendar export to Google & Apple Calendar","Income forecasting — confirmed vs at-risk"],
      target:"Ideal for: Property agents, insurance advisors, freelance designers & sole business owners",
    },
  ];
...
export default function App(){
  const[mode,setMode]=useState(null); // null | "enterprise" | "sme" | "solo"

  if(!mode) return <LandingScreen onSelect={setMode}/>;
  if(mode==="enterprise") return <EnterpriseApp onBack={()=>setMode(null)}/>;
  if(mode==="sme")        return <SmeApp   onBack={()=>setMode(null)}/>;
  return <SoloApp onBack={()=>setMode(null)}/>;
}

// ═══════════════════════════════════════════════════════════════════════════
// SOLO MODE — Sales Intelligence for the Individual Business Owner
// ═══════════════════════════════════════════════════════════════════════════

// ── SOLO DESIGN TOKENS ────────────────────────────────────────────────────────
const SL = {
  bg:"#080c18", bgCard:"#0d1020", bgSec:"#111525", bgAccent:"#0D2E2A",
  border:"rgba(255,255,255,0.07)", borderT:"rgba(13,148,136,0.4)",
  teal:"#0D9488", tealL:"#14B8A6", tealDim:"#0D4F4A",
  gold:"#D4A017", goldL:"#F0C040",
  white:"#FFFFFF", ice:"#CBD5E1", muted:"#94A3B8", dim:"#64748B",
  green:"#10B981", red:"#EF4444", amber:"#F59E0B", blue:"#3B82F6", purple:"#8B5CF6",
  text:"#E2E8F0",
};
const slcard=(extra={})=>({background:SL.bgCard,border:`1px solid ${SL.border}`,borderRadius:10,padding:16,...extra});
const sltag=(c)=>({fontSize:9,fontFamily:"'JetBrains Mono',monospace",letterSpacing:1,padding:"2px 8px",borderRadius:20,border:`1px solid ${c}30`,color:c,background:`${c}12`});
const slbtn=(c=SL.teal,ex={})=>({display:"inline-flex",alignItems:"center",gap:6,padding:"8px 16px",borderRadius:8,fontSize:12,fontWeight:600,cursor:"pointer",border:"none",transition:"all 0.15s",background:c,color:"#fff",...ex});
function SLTag({c,children}){return <span style={sltag(c)}>{children}</span>;}

// ── SOLO INDUSTRY DATA ────────────────────────────────────────────────────────
const SOLO_INDUSTRIES = [
  {
    id:"realtor", label:"Realtor / Property Agent", icon:"🏠", color:"#0D9488",
    bizName:"Alex Tan", role:"Senior Property Agent", location:"Singapore",
    currency:"S$", currencyCode:"SGD",
    kpis:[
      {label:"Commission MTD",    value:"S$18,400", change:"+22%",  pos:true,  sub:"vs S$15,100 last month"},
      {label:"Active Deals",      value:"28",        change:"+3",    pos:true,  sub:"6 high heat · 14 warm · 8 cold"},
      {label:"Deals Closed MTD",  value:"3",         change:"-1",    pos:false, sub:"1 sale · 2 rentals"},
      {label:"Avg Deal Cycle",    value:"47 days",   change:"+4d",   pos:false, sub:"Benchmark: 38 days"},
      {label:"Follow-up Rate",    value:"72%",        change:"-8pp",  pos:false, sub:"Contacts reached this week"},
      {label:"Pipeline Value",    value:"S$84,200",  change:"+12%",  pos:true,  sub:"If all deals close"},
    ],
    questions:[
      "Which of my leads is most likely to transact this week?",
      "My seller wants S$680K for his Toa Payoh 4-room. Is that right?",
      "New Clementi listing dropped. Which of my buyers should I contact?",
      "Which landlord clients have expiring tenancies I might lose?",
      "How do I get my average deal cycle down from 47 to 38 days?",
      "Am I spending enough time on sales vs rentals?",
    ],
    pipelineStages:["Prospect","Active","Offer Stage","Closed"],
    deals:[
      {id:"d1",name:"Lim Family",type:"buyer",stage:"Active",value:"S$12,000",heat:"high",lastContact:11,phone:"6591234567",note:"Looking for 4-room HDB Tampines, budget S$550K. Viewed 2 units. Going cold.",due:"Today"},
      {id:"d2",name:"Tan Couple",type:"buyer",stage:"Offer Stage",value:"S$18,000",heat:"high",lastContact:2,phone:"6598765432",note:"Budget S$1.45M, 3-bed condo west side. 2 viewings done. Waiting on spouse.",due:"This week"},
      {id:"d3",name:"Kumar Family",type:"buyer",stage:"Prospect",value:"S$8,000",heat:"cold",lastContact:22,phone:"6592345678",note:"No response 3 weeks. May be working with another agent.",due:"Reactivate"},
      {id:"d4",name:"Wong Landlord",type:"landlord",stage:"Active",value:"S$2,800",heat:"medium",lastContact:31,phone:"6593456789",note:"Toa Payoh tenancy expires in 47 days. Needs renewal.",due:"47 days"},
      {id:"d5",name:"Ng Property",type:"seller",stage:"Active",value:"S$15,000",heat:"medium",lastContact:5,phone:"6594567890",note:"4-room Toa Payoh, asking S$680K. Priced 14% above median.",due:"Active listing"},
      {id:"d6",name:"Chan Rental",type:"landlord",stage:"Prospect",value:"S$1,800",heat:"high",lastContact:38,phone:"6595678901",note:"Bishan unit. Tenancy expires in 38 days. No contact recorded — HIGH risk.",due:"38 days"},
    ],
    calendarItems:[
      {title:"Viewing — Lim Family, Tampines St 22",date:"2026-04-05",time:"10:00",type:"viewing",contact:"Lim Family"},
      {title:"Offer deadline — Tan Couple, Clementi",date:"2026-04-07",time:"17:00",type:"deadline",contact:"Tan Couple"},
      {title:"Tenancy expiry — Chan, Bishan",date:"2026-05-10",time:"",type:"expiry",contact:"Chan Rental"},
      {title:"Tenancy expiry — Wong, Toa Payoh",date:"2026-05-19",time:"",type:"expiry",contact:"Wong Landlord"},
      {title:"Follow-up — Kumar Family reactivation",date:"2026-04-08",time:"09:00",type:"followup",contact:"Kumar Family"},
    ],
  },
  {
    id:"insurance", label:"Insurance / Financial Advisor", icon:"🛡", color:"#D4A017",
    bizName:"Sarah Chen", role:"Senior Financial Advisor", location:"Singapore",
    currency:"S$", currencyCode:"SGD",
    kpis:[
      {label:"Commission MTD",     value:"S$11,200", change:"+8%",   pos:true,  sub:"New business + renewals"},
      {label:"Active Clients",     value:"142",       change:"+4",    pos:true,  sub:"87 active policies"},
      {label:"Renewals Due 30d",   value:"7",         change:"",      pos:false, sub:"3 HIGH risk · 4 LOW risk"},
      {label:"New Policies MTD",   value:"4",         change:"-2",    pos:false, sub:"Target: 6/month"},
      {label:"Retention Rate",     value:"91%",       change:"-2pp",  pos:false, sub:"Benchmark: 94%"},
      {label:"AUM",                value:"S$2.4M",    change:"+S$80K",pos:true,  sub:"Total portfolio value"},
    ],
    questions:[
      "Which of my policies are at highest risk of lapsing this month?",
      "Which clients have coverage gaps I should be addressing?",
      "How do I hit my S$15,000 income target this month?",
      "Which clients are most ready for an annual review conversation?",
      "How do I grow my AUM by 20% this year?",
      "Am I spending time on the right client segments?",
    ],
    pipelineStages:["Prospect","Proposal Sent","Under Review","Closed Won"],
    deals:[
      {id:"d1",name:"Lee Family",type:"renewal",stage:"Active",value:"S$3,200",heat:"high",lastContact:58,phone:"6596789012",note:"Whole life policy renewal. Last contact 58 days ago. URGENT — lapse risk.",due:"12 days"},
      {id:"d2",name:"Ahmad Bin Yusof",type:"renewal",stage:"Active",value:"S$890",heat:"high",lastContact:71,phone:"6597890123",note:"Hospitalisation plan renewal. No contact in 71 days. Very high lapse risk.",due:"8 days"},
      {id:"d3",name:"Seah Siew Lan",type:"renewal",stage:"Active",value:"S$1,450",heat:"low",lastContact:12,phone:"6598901234",note:"ILP renewal. Recently contacted. Low risk.",due:"28 days"},
      {id:"d4",name:"Patel Family",type:"new",stage:"Proposal Sent",value:"S$4,800",heat:"high",lastContact:3,phone:"6599012345",note:"Term life + critical illness proposal sent. Following up Thursday.",due:"Thursday"},
      {id:"d5",name:"Tan Wei Ming",type:"cross-sell",stage:"Prospect",value:"S$2,100",heat:"medium",lastContact:14,phone:"6590123456",note:"Has life cover, no CI. Earns S$9K/month. Strong cross-sell candidate.",due:"This week"},
      {id:"d6",name:"Wong Mei Ling",type:"new",stage:"Under Review",value:"S$3,600",heat:"medium",lastContact:6,phone:"6591230000",note:"Reviewing ILP proposal with husband. Decision expected end of week.",due:"Friday"},
    ],
    calendarItems:[
      {title:"Policy renewal deadline — Ahmad hospitalisation",date:"2026-04-10",time:"",type:"deadline",contact:"Ahmad Bin Yusof"},
      {title:"Annual review — Patel Family",date:"2026-04-09",time:"14:00",type:"review",contact:"Patel Family"},
      {title:"Follow-up call — Wong Mei Ling",date:"2026-04-11",time:"10:00",type:"followup",contact:"Wong Mei Ling"},
      {title:"Policy renewal — Lee Family whole life",date:"2026-04-14",time:"",type:"deadline",contact:"Lee Family"},
      {title:"Cross-sell meeting — Tan Wei Ming",date:"2026-04-12",time:"11:00",type:"meeting",contact:"Tan Wei Ming"},
    ],
  },
  {
    id:"personal", label:"Freelance Designer", icon:"🎨", color:"#8B5CF6",
    bizName:"Maya Lim", role:"Freelance Brand & UI Designer", location:"Singapore",
    currency:"S$", currencyCode:"SGD",
    kpis:[
      {label:"Revenue MTD",        value:"S$6,800",  change:"+18%",  pos:true,  sub:"vs S$5,760 last month"},
      {label:"Active Projects",    value:"5",         change:"+1",    pos:true,  sub:"3 in progress · 2 quoted"},
      {label:"Avg Project Value",  value:"S$2,267",   change:"+S$320",pos:true,  sub:"vs S$1,947 last month"},
      {label:"Enquiries MTD",      value:"8",         change:"+2",    pos:true,  sub:"3 pending response"},
      {label:"Conversion Rate",    value:"63%",       change:"+8pp",  pos:true,  sub:"Enquiries to confirmed"},
      {label:"Utilisation Rate",   value:"78%",       change:"+5pp",  pos:true,  sub:"Billable hrs vs capacity"},
    ],
    questions:[
      "Am I pricing my branding projects correctly vs market rates?",
      "Which pending enquiries should I follow up on today?",
      "How do I grow from S$6,800 to S$12,000/month revenue?",
      "Should I raise my day rate for UI design projects?",
      "Which client types give me the best margin per hour?",
      "How do I reduce scope creep and protect my project margins?",
    ],
    pipelineStages:["Enquiry","Proposal Sent","In Progress","Review & Handover"],
    deals:[
      {id:"d1",name:"Bloom & Co",type:"branding",stage:"Enquiry",value:"S$3,200",heat:"high",lastContact:4,phone:"6592223333",note:"Full brand identity for F&B startup. Budget confirmed S$3K+. Decision this week.",due:"Today"},
      {id:"d2",name:"NovaTech Pte Ltd",type:"ui-design",stage:"Proposal Sent",value:"S$4,500",heat:"high",lastContact:3,phone:"6593334444",note:"Mobile app UI redesign, 3 screens + design system. Proposal sent 3 days ago — no reply.",due:"Follow up"},
      {id:"d3",name:"The Green Collective",type:"branding",stage:"In Progress",value:"S$2,800",heat:"low",lastContact:1,phone:"6594445555",note:"Logo + brand guidelines. 60% complete. Final delivery 18 Apr.",due:"18 Apr"},
      {id:"d4",name:"Kiran Wellness",type:"website",stage:"Review & Handover",value:"S$1,800",heat:"low",lastContact:2,phone:"6595556666",note:"5-page Webflow site. Client reviewing final version. Invoice pending approval.",due:"Collect payment"},
      {id:"d5",name:"Tan & Partners Law",type:"ui-design",stage:"Enquiry",value:"S$2,400",heat:"medium",lastContact:8,phone:"6596667777",note:"Portal UI redesign. Enquired last week — followed up once, no reply.",due:"Re-contact"},
      {id:"d6",name:"Starboard Media",type:"branding",stage:"Proposal Sent",value:"S$5,500",heat:"high",lastContact:2,phone:"6597778888",note:"Rebrand for media agency — logo, deck templates, social kit. Biggest deal in pipeline.",due:"This week"},
    ],
    calendarItems:[
      {title:"Final delivery — The Green Collective brand guidelines",date:"2026-04-18",time:"10:00",type:"delivery",contact:"The Green Collective"},
      {title:"Client review — Kiran Wellness website",date:"2026-04-07",time:"14:00",type:"review",contact:"Kiran Wellness"},
      {title:"Proposal follow-up — NovaTech UI",date:"2026-04-06",time:"09:00",type:"followup",contact:"NovaTech Pte Ltd"},
      {title:"Kick-off call — Bloom & Co branding",date:"2026-04-08",time:"11:00",type:"meeting",contact:"Bloom & Co"},
      {title:"Proposal deadline — Starboard Media rebrand",date:"2026-04-09",time:"17:00",type:"deadline",contact:"Starboard Media"},
    ],
  },
];

// ── ICS CALENDAR HELPER ───────────────────────────────────────────────────────
function generateICS(item, bizName){
  const dtStart = item.date.replace(/-/g,"") + (item.time ? "T" + item.time.replace(":","") + "00" : "");
  const dtEnd   = item.date.replace(/-/g,"") + (item.time ? "T" + (String(parseInt(item.time)+1).padStart(2,"0") + item.time.slice(2)).replace(":","") + "00" : "");
  const uid = `aether-${Date.now()}@solo`;
  return [
    "BEGIN:VCALENDAR","VERSION:2.0","PRODID:-//Aether Solo//EN","BEGIN:VEVENT",
    `UID:${uid}`,`DTSTART:${dtStart}`,`DTEND:${dtEnd||dtStart}`,
    `SUMMARY:${item.title}`,`DESCRIPTION:${item.contact} — via Aether Solo · ${bizName}`,
    "END:VEVENT","END:VCALENDAR"
  ].join("\r\n");
}
function downloadICS(item, bizName){
  const blob=new Blob([generateICS(item,bizName)],{type:"text/calendar"});
  const url=URL.createObjectURL(blob);
  const a=document.createElement("a");
  a.href=url; a.download=`${item.title.slice(0,40).replace(/[^a-z0-9]/gi,"_")}.ics`;
  a.click(); URL.revokeObjectURL(url);
}
function googleCalLink(item){
  const dt=item.date.replace(/-/g,"");
  const dates=item.time ? `${dt}T${item.time.replace(":","")+"00"}/${dt}T${item.time.replace(":","")+"00"}` : `${dt}/${dt}`;
  return `https://calendar.google.com/calendar/render?action=TEMPLATE&text=${encodeURIComponent(item.title)}&dates=${dates}&details=${encodeURIComponent(item.contact)}`;
}

// ── HEAT BADGE ────────────────────────────────────────────────────────────────
function HeatBadge({heat}){
  const map={high:{c:SL.red,label:"HOT"},medium:{c:SL.amber,label:"WARM"},low:{c:SL.dim,label:"COOL"}};
  const s=map[heat]||map.low;
  return <span style={{...sltag(s.c),fontWeight:800}}>{s.label}</span>;
}

// ── CONTACTS MANAGER (shared state lifted to SoloApp) ─────────────────────────
function ContactsPanel({contacts, setContacts, color}){
  const[form,setForm]=useState({name:"",phone:"",type:"",note:""});
  const[open,setOpen]=useState(false);
  const add=()=>{
    if(!form.name||!form.phone)return;
    setContacts(p=>[...p,{...form,id:`c-${Date.now()}`}]);
    setForm({name:"",phone:"",type:"",note:""});
    setOpen(false);
  };
  return(
    <div style={{...slcard(),marginBottom:12}}>
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8}}>
        <div style={{fontSize:12,fontWeight:700,color:SL.text}}>My Contacts</div>
        <button onClick={()=>setOpen(p=>!p)} style={{...slbtn(color,{fontSize:10,padding:"4px 10px"})}}>+ Add</button>
      </div>
      {open&&(
        <div style={{background:SL.bgSec,borderRadius:7,padding:10,marginBottom:8,display:"grid",gridTemplateColumns:"1fr 1fr",gap:6}}>
          {[
            {key:"name",ph:"Full name *"},
            {key:"phone",ph:"Phone (e.g. 6591234567) *"},
            {key:"type",ph:"Type (buyer / landlord / client)"},
            {key:"note",ph:"Notes"},
          ].map(f=>(
            <input key={f.key} value={form[f.key]} onChange={e=>setForm(p=>({...p,[f.key]:e.target.value}))}
              placeholder={f.ph} style={{background:SL.bgCard,border:`1px solid ${SL.border}`,borderRadius:5,padding:"6px 8px",fontSize:10,color:SL.text,outline:"none",fontFamily:"inherit"}}/>
          ))}
          <button onClick={add} style={{...slbtn(color,{fontSize:10,padding:"6px",gridColumn:"1/-1",justifyContent:"center"})}}>Save Contact</button>
        </div>
      )}
      <div style={{display:"flex",flexDirection:"column",gap:4,maxHeight:160,overflowY:"auto"}}>
        {contacts.length===0&&<div style={{fontSize:10,color:SL.muted,textAlign:"center",padding:"8px 0"}}>No contacts yet — add your first one above</div>}
        {contacts.map(c=>(
          <div key={c.id} style={{display:"flex",gap:8,alignItems:"center",background:SL.bgSec,borderRadius:5,padding:"6px 8px"}}>
            <div style={{width:24,height:24,borderRadius:"50%",background:`${color}20`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:11,fontWeight:700,color,flexShrink:0}}>{c.name[0]}</div>
            <div style={{flex:1,minWidth:0}}>
              <div style={{fontSize:10,fontWeight:600,color:SL.text}}>{c.name}</div>
              <div style={{fontSize:9,color:SL.muted,fontFamily:"'JetBrains Mono',monospace"}}>{c.phone}{c.type?` · ${c.type}`:""}</div>
            </div>
            <button onClick={()=>setContacts(p=>p.filter(x=>x.id!==c.id))} style={{fontSize:12,color:SL.dim,background:"none",border:"none",cursor:"pointer"}}>×</button>
          </div>
        ))}
      </div>
    </div>
...
// ── WHATSAPP MESSAGE SENDER WITH CONTACT SELECTOR ────────────────────────────
function SoloWhatsAppSend({industry, contacts, context, label}){
  const[open,setOpen]=useState(false);
  const[step,setStep]=useState("idle");
  const[msg,setMsg]=useState("");
  const[selectedContact,setSelectedContact]=useState(null);

  const generate=async(ctxOverride)=>{
    setStep("generating");
    try{
      const system=`Write a WhatsApp message for ${industry.bizName} (${industry.label}, ${industry.location}). Warm and personal. Max 180 chars. Start with "Hi [Name]," or use actual name if known. End with sender's name. Return ONLY the message text.`;
      const result=await callClaude([{role:"user",content:ctxOverride||context}],system,false,"whatsapp");
      setMsg(result.text.trim());
      setStep("edit");
    }catch(e){
      setMsg(`Hi [Name], ${(ctxOverride||context).slice(0,80)}... — ${industry.bizName}`);
      setStep("edit");
    }
  };
  ...
  if(!open) return(
    <button onClick={()=>{setOpen(true);generate();}} style={{display:"inline-flex",alignItems:"center",gap:6,padding:"6px 12px",borderRadius:7,border:"1px solid rgba(37,209,102,0.4)",background:"rgba(37,209,102,0.1)",color:"#25D166",fontSize:11,fontWeight:600,cursor:"pointer",fontFamily:"inherit",marginTop:6}}>
      💬 Send via WhatsApp
    </button>
  );

  return(
    <div style={{marginTop:8,background:SL.bgCard,border:"1px solid rgba(37,209,102,0.3)",borderRadius:10,overflow:"hidden",animation:"fadeIn 0.2s ease"}}>
      <div style={{background:"rgba(37,209,102,0.1)",borderBottom:"1px solid rgba(37,209,102,0.2)",padding:"8px 12px",display:"flex",justifyContent:"space-between",alignItems:"center"}}>
        <div style={{fontSize:11,fontWeight:700,color:"#25D166"}}>💬 Send via WhatsApp  <span style={{fontSize:9,color:SL.muted,fontFamily:"'JetBrains Mono',monospace"}}>MESSAGE OPENS DIRECTLY IN WHATSAPP</span></div>
        <button onClick={()=>{setOpen(false);setStep("idle");setMsg("");setSelectedContact(null);}} style={{background:"none",border:"none",color:SL.muted,cursor:"pointer",fontSize:16}}>×</button>
      </div>
      <div style={{padding:"10px 12px"}}>

        {/* Contact selector */}
        <div style={{marginBottom:10}}>
          <div style={{fontSize:9,color:SL.muted,fontFamily:"'JetBrains Mono',monospace",letterSpacing:1,marginBottom:5}}>SELECT CONTACT (opens their WhatsApp chat)</div>
          <div style={{display:"flex",gap:6,flexWrap:"wrap"}}>
            {contacts.map(c=>(
              <button key={c.id} onClick={()=>setSelectedContact(c)}
                style={{fontSize:10,padding:"4px 10px",borderRadius:5,border:`1px solid ${selectedContact?.id===c.id?"#25D166":SL.border}`,background:selectedContact?.id===c.id?"rgba(37,209,102,0.12)":"transparent",color:selectedContact?.id===c.id?"#25D166":SL.muted,cursor:"pointer",fontFamily:"inherit"}}>
                {c.name}
              </button>
            ))}
            {contacts.length===0&&<span style={{fontSize:10,color:SL.dim,fontStyle:"italic"}}>No contacts saved — add contacts in the Pipeline tab</span>}
            <button onClick={()=>setSelectedContact(null)}
              style={{fontSize:10,padding:"4px 10px",borderRadius:5,border:`1px solid ${!selectedContact?"#25D166":SL.border}`,background:!selectedContact?"rgba(37,209,102,0.12)":"transparent",color:!selectedContact?"#25D166":SL.muted,cursor:"pointer",fontFamily:"inherit"}}>
              No contact (I'll pick in WhatsApp)
            </button>
          </div>
          {selectedContact&&<div style={{fontSize:9,color:"#25D166",marginTop:4,fontFamily:"'JetBrains Mono',monospace"}}>→ Will open WhatsApp chat with {selectedContact.name} (+{selectedContact.phone})</div>}
        </div>

        {step==="generating"&&(
          <div style={{display:"flex",alignItems:"center",gap:8,padding:"10px 0"}}>
            <div style={{display:"flex",gap:4}}>{[0,1,2].map(i=><div key={i} style={{width:5,height:5,borderRadius:"50%",background:"#25D166",animation:`bounce 1.1s infinite ${i*0.18}s`}}/>)}</div>
            <span style={{fontSize:11,color:SL.muted}}>Crafting your message...</span>
          </div>
        )}

        {step==="edit"&&(
          <>
            <div style={{fontSize:9,color:SL.muted,fontFamily:"'JetBrains Mono',monospace",letterSpacing:1,marginBottom:5}}>REVIEW & EDIT — THEN OPEN IN WHATSAPP</div>
            <textarea value={msg} onChange={e=>setMsg(e.target.value)} rows={4}
              style={{width:"100%",background:SL.bgSec,border:"1px solid rgba(37,209,102,0.3)",borderRadius:6,padding:"8px 10px",fontSize:11,color:SL.text,outline:"none",resize:"none",fontFamily:"inherit",lineHeight:1.6}}/>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginTop:4,marginBottom:8}}>
              <span style={{fontSize:9,color:msg.length>200?SL.red:SL.muted,fontFamily:"'JetBrains Mono',monospace"}}>{msg.length} chars</span>
              <button onClick={()=>generate()} style={{fontSize:10,color:SL.muted,background:"none",border:"none",cursor:"pointer"}}>↺ Regenerate</button>
            </div>
            <button onClick={send} style={{...slbtn("#25D166",{fontSize:11,padding:"8px 16px",width:"100%",justifyContent:"center"})}}>
              💬 Open WhatsApp{selectedContact?` → ${selectedContact.name}`:" & Send"}
            </button>
          </>
        )}
        ...
        {step==="sent"&&(
          <div style={{textAlign:"center",padding:"12px 0"}}>
            ...
            <div style={{fontSize:12,fontWeight:700,color:SL.text,marginBottom:3}}>WhatsApp opened!</div>
            <div style={{fontSize:10,color:SL.muted,marginBottom:10}}>Message is pre-typed in the chat. Tap Send to deliver.</div>
            <div style={{display:"flex",gap:8,justifyContent:"center"}}>
              <button onClick={()=>setStep("edit")} style={{fontSize:10,color:"#25D166",background:"none",border:"1px solid rgba(37,209,102,0.3)",borderRadius:5,padding:"5px 12px",cursor:"pointer",fontFamily:"inherit"}}>Edit & Resend</button>
              <button onClick={()=>{setOpen(false);setStep("idle");setMsg("");setSelectedContact(null);}} style={{fontSize:10,color:SL.muted,background:"none",border:"none",cursor:"pointer"}}>Done</button>
            </div>
          </div>
        )}
      </div>
...
// ── SOLO PIPELINE TAB ─────────────────────────────────────────────────────────
function SoloPipeline({industry, contacts, setContacts, bizHealth, setBizHealth}){
  const[deals,setDeals]=useState(industry.deals);
  const[activeStage,setActiveStage]=useState("all");
  const[expandedDeal,setExpandedDeal]=useState(null);
  const[aiAction,setAiAction]=useState({});
  const[loadingAction,setLoadingAction]=useState({});

  const allContacts=[...contacts,...deals.map(d=>({id:d.id,name:d.name,phone:d.phone,type:d.type}))];
  const filtered=activeStage==="all"?deals:deals.filter(d=>d.stage===activeStage);
  const heatOrder={high:0,medium:1,low:2};
  const sorted=[...filtered].sort((a,b)=>(heatOrder[a.heat]||2)-(heatOrder[b.heat]||2));

  const confirmed=deals.filter(d=>["Confirmed","In Progress","Delivered","Closed Won"].includes(d.stage)).reduce((s,d)=>s+toNum(d.value),0);
  const atRisk=deals.filter(d=>d.heat==="medium"&&["Quote Sent","Proposal Sent"].includes(d.stage)).reduce((s,d)=>s+toNum(d.value),0);
  const fullPipe=deals.reduce((s,d)=>s+toNum(d.value),0);
  const cur=industry.currency;

  // Get AI-generated action for a deal
  const getAiAction=async(deal)=>{
    const key=deal.id;
    if(aiAction[key]||loadingAction[key])return;
    setLoadingAction(p=>({...p,[key]:true}));
    const system=`You are Aether Solo. Give ONE specific action the user should take on this deal TODAY. Max 2 sentences. Reference the contact name. Be concrete — not "follow up" but "send X message saying Y" or "call at Z time". End with expected outcome.`;
    const ctx=`Deal: ${deal.name} | Type: ${deal.type} | Stage: ${deal.stage} | Heat: ${deal.heat} | Value: ${deal.value} | Last contact: ${deal.lastContact} days ago | Note: ${deal.note} | Due: ${deal.due}`;
    try{
      const result=await callClaude([{role:"user",content:ctx}],system,false,"action");
      setAiAction(p=>({...p,[key]:result.text}));
    }catch(e){
      setAiAction(p=>({...p,[key]:"Add VITE_ANTHROPIC_KEY to enable AI action suggestions."}));
    }
    setLoadingAction(p=>({...p,[key]:false}));
  };

  return(
    <div style={{flex:1,overflowY:"auto",padding:20,background:SL.bg,display:"flex",flexDirection:"column",gap:14}}>

      {/* Income forecast strip */}
      <div style={{...slcard(),background:"#080c18",border:`1px solid ${SL.border}`,padding:"12px 16px"}}>
        <div style={{fontSize:9,color:"rgba(255,255,255,0.4)",letterSpacing:2,textTransform:"uppercase",fontFamily:"'JetBrains Mono',monospace",marginBottom:8}}>Income Forecast — Forward Looking</div>
        <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:8}}>
          {[
            {l:"Confirmed",v:confirmed,c:"34d399",s:"High-probability"},
            {l:"At Risk",  v:atRisk,   c:"f59e0b",s:"Awaiting decision"},
            {l:"Pipeline", v:fullPipe, c:"60a5fa",s:"If all close"},
            {l:"Hot Deals",v:deals.filter(d=>d.heat==="high").length,c:SL.red.replace("#",""),s:"Needs action today",noPrefix:true},
          ].map(s=>(
            <div key={s.l}>
              <div style={{fontSize:18,fontWeight:900,color:`#${s.c}`,fontFamily:"'JetBrains Mono',monospace"}}>{s.noPrefix?s.v:`${cur}${s.v.toLocaleString()}`}</div>
              <div style={{fontSize:9,color:"rgba(255,255,255,0.45)",textTransform:"uppercase",letterSpacing:1,fontFamily:"'JetBrains Mono',monospace"}}>{s.l}</div>
              <div style={{fontSize:8,color:"rgba(255,255,255,0.28)",marginTop:1}}>{s.s}</div>
            </div>
          ))}
        </div>
      </div>

      {/* Renewal/Expiry Intelligence — Realtor only */}
      {industry.id==="realtor"&&(()=>{
        const expiring=deals.filter(d=>d.type==="landlord"&&d.due&&d.due.includes("day"));
        if(!expiring.length) return null;
        return(
          <div style={{...slcard(),border:`1px solid ${SL.amber}40`,background:`${SL.amber}08`}}>
            <div style={{fontSize:12,fontWeight:800,color:SL.amber,marginBottom:8}}>⏰ Tenancy Renewal Intelligence — Action Required</div>
            <div style={{display:"flex",flexDirection:"column",gap:6}}>
              {expiring.map(d=>{
                const days=parseInt(d.due);
                const risk=d.lastContact>30?"HIGH":d.lastContact>14?"MEDIUM":"LOW";
                const riskC=risk==="HIGH"?SL.red:risk==="MEDIUM"?SL.amber:SL.green;
                return(
                  <div key={d.id} style={{display:"grid",gridTemplateColumns:"1fr auto auto auto",gap:10,alignItems:"center",background:SL.bgSec,borderRadius:6,padding:"8px 12px"}}>
                    <div>
                      <div style={{fontSize:11,fontWeight:700,color:SL.text}}>{d.name}</div>
                      <div style={{fontSize:10,color:SL.muted}}>{d.note.slice(0,60)}...</div>
                    </div>
                    <span style={{...sltag(riskC),fontWeight:700}}>{risk} RISK</span>
                    <span style={{fontSize:10,fontFamily:"'JetBrains Mono',monospace",color:SL.amber}}>{days} days left</span>
                    <SoloWhatsAppSend industry={industry} contacts={allContacts}
                      context={`Send a tenancy renewal check-in to ${d.name}. The lease expires in ${days} days. Last contact was ${d.lastContact} days ago. Be warm and proactive — ask if they plan to renew and offer to handle the paperwork.`}
                      label="Send renewal message"/>
                  </div>
                );
              })}
            </div>
      ...
      {/* PropertyGuru / URA Price Intelligence — Realtor only */}
      {industry.id==="realtor"&&(
        <div style={slcard()}>
          <div style={{fontSize:12,fontWeight:800,color:SL.text,marginBottom:4}}>🏠 PropertyGuru Price Intelligence</div>
          <div style={{fontSize:11,color:SL.muted,marginBottom:12}}>URA transaction data in the context of your active listings and buyer budgets</div>
          <div style={{display:"flex",flexDirection:"column",gap:8}}>
            {[
              {listing:"Ng Property — Toa Payoh 4-room",asking:"S$680,000",median:"S$598,000",range:"S$572–621K",txns:6,gap:"+13.7%",rec:"List at S$628K — premium justified by high floor (18th) and recent renovation. Expected time to transact: 8–12 weeks.",gapC:SL.amber},
              {listing:"Lim Family budget — Tampines HDB",asking:"S$550,000",median:"S$524,000",range:"S$498–558K",txns:9,gap:"On budget",rec:"3 units in block 847 within budget. Last transaction 2 weeks ago at S$531K on 8th floor. Good entry price — recommend viewing soon before next round.",gapC:SL.green},
            ].map((r,i)=>(
              <div key={i} style={{background:SL.bgSec,borderRadius:7,padding:"10px 14px",border:`1px solid ${SL.border}`}}>
                <div style={{fontSize:11,fontWeight:700,color:SL.text,marginBottom:6}}>{r.listing}</div>
                <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:8,marginBottom:8}}>
                  {[
                    {l:"Asking/Budget",v:r.asking,c:SL.text},
                    {l:"URA Median",   v:r.median,c:SL.muted},
                    {l:"Txn Range",   v:r.range, c:SL.muted},
                    {l:"Gap",         v:r.gap,   c:r.gapC},
                  ].map(m=>(
                    <div key={m.l}>
                      <div style={{fontSize:8,color:SL.dim,letterSpacing:1,textTransform:"uppercase",fontFamily:"'JetBrains Mono',monospace",marginBottom:2}}>{m.l}</div>
                      <div style={{fontSize:12,fontWeight:700,color:m.c,fontFamily:"'JetBrains Mono',monospace"}}>{m.v}</div>
                    </div>
                  ))}
                </div>
                <div style={{background:`${SL.teal}10`,borderRadius:5,padding:"7px 10px",border:`1px solid ${SL.teal}25`}}>
                  <span style={{fontSize:9,fontWeight:700,color:SL.tealL}}>⚡ Aether: </span>
                  <span style={{fontSize:10,color:SL.muted}}>{r.rec}</span>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* Stage filter pills */}
      <div style={{display:"flex",gap:8,flexWrap:"wrap",alignItems:"center"}}>
        <span style={{fontSize:10,color:SL.muted,fontFamily:"'JetBrains Mono',monospace",letterSpacing:1}}>FILTER:</span>
        {["all",...industry.pipelineStages].map(stage=>(
          <button key={stage} onClick={()=>setActiveStage(stage)} style={{fontSize:11,padding:"5px 14px",borderRadius:20,border:`1.5px solid ${activeStage===stage?industry.color:SL.border}`,background:activeStage===stage?`${industry.color}15`:"transparent",color:activeStage===stage?industry.color:SL.muted,cursor:"pointer",fontFamily:"inherit",fontWeight:activeStage===stage?700:400}}>
            {stage==="all"?"All":stage} <span style={{fontSize:9,fontFamily:"'JetBrains Mono',monospace"}}>({(stage==="all"?deals:deals.filter(d=>d.stage===stage)).length})</span>
          </button>
        ))}
      </div>

      {/* Two-col: deals + contacts/summary */}
      <div style={{display:"grid",gridTemplateColumns:"1fr 260px",gap:14,alignItems:"start"}}>
        <div style={{display:"flex",flexDirection:"column",gap:8}}>
          {sorted.map(deal=>(
            <div key={deal.id} style={{...slcard(),border:`1px solid ${deal.heat==="high"?SL.red+"50":deal.heat==="medium"?SL.amber+"35":SL.border}`,overflow:"hidden"}}>
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",gap:10}}>
                <div style={{flex:1}}>
                  <div style={{display:"flex",alignItems:"center",gap:7,marginBottom:4,flexWrap:"wrap"}}>
                    <span style={{fontSize:13,fontWeight:700,color:SL.text}}>{deal.name}</span>
                    <HeatBadge heat={deal.heat}/>
                    <SLTag c={SL.dim}>{deal.stage}</SLTag>
                    <SLTag c={SL.teal}>{deal.type}</SLTag>
                  </div>
                  <div style={{fontSize:11,color:SL.muted,lineHeight:1.5,marginBottom:5}}>{deal.note}</div>
                  <div style={{display:"flex",gap:10,alignItems:"center",flexWrap:"wrap"}}>
                    <span style={{fontSize:10,fontFamily:"'JetBrains Mono',monospace",color:SL.dim}}>Last: {deal.lastContact}d ago</span>
                    <span style={{fontSize:10,color:SL.amber,fontFamily:"'JetBrains Mono',monospace"}}>Due: {deal.due}</span>
                    <span style={{fontSize:13,fontWeight:800,color:industry.color,fontFamily:"'JetBrains Mono',monospace"}}>{deal.value}</span>
                  </div>
                </div>
                <div style={{display:"flex",flexDirection:"column",gap:5,flexShrink:0,alignItems:"flex-end"}}>
                  <select value={deal.stage} onChange={e=>setDeals(p=>p.map(d=>d.id===deal.id?{...d,stage:e.target.value}:d))}
                    style={{background:SL.bgSec,border:`1px solid ${SL.border}`,borderRadius:5,padding:"4px 6px",fontSize:10,color:SL.text,cursor:"pointer",fontFamily:"inherit"}}>
                    {industry.pipelineStages.map(s=><option key={s} value={s}>{s}</option>)}
                  </select>
                  <button onClick={()=>{setExpandedDeal(expandedDeal===deal.id?null:deal.id);if(expandedDeal!==deal.id)getAiAction(deal);}}
                    style={{fontSize:10,padding:"4px 10px",borderRadius:5,border:`1px solid ${industry.color}40`,background:`${industry.color}10`,color:industry.color,cursor:"pointer",fontFamily:"inherit",fontWeight:600}}>
                    {expandedDeal===deal.id?"▲ Less":"🧠 AI Action"}
                  </button>
                </div>
              </div>
              ...
              {expandedDeal===deal.id&&(
                <div style={{marginTop:10,paddingTop:10,borderTop:`1px solid ${SL.border}`}}>
                  <div style={{background:SL.bgSec,borderRadius:7,padding:"10px 12px",marginBottom:8}}>
                    <div style={{fontSize:9,fontWeight:700,color:industry.color,letterSpacing:1,fontFamily:"'JetBrains Mono',monospace",marginBottom:5}}>⚡ AETHER RECOMMENDED ACTION</div>
                    {loadingAction[deal.id]?(
                      <div style={{display:"flex",gap:4}}>{[0,1,2].map(i=><div key={i} style={{width:5,height:5,borderRadius:"50%",background:industry.color,animation:`bounce 1.1s infinite ${i*0.18}s`}}/>)}</div>
                    ):(
                      <div style={{fontSize:11,color:SL.text,lineHeight:1.6}}>{aiAction[deal.id]||"Click AI Action to generate a specific recommendation for this deal."}</div>
                    )}
                  </div>
                  <SoloWhatsAppSend industry={industry} contacts={allContacts}
                    context={`${aiAction[deal.id]||deal.note} Contact: ${deal.name}, deal value ${deal.value}.`}
                    label={`Message ${deal.name}`}/>
                </div>
              )}
            </div>
          ))}
        ...
        {/* Right column: contacts + deal source tracker */}
        <div>
          <ContactsPanel contacts={contacts} setContacts={setContacts} color={industry.color}/>
          <div style={{...slcard(),marginTop:0}}>
            <div style={{fontSize:11,fontWeight:700,color:SL.text,marginBottom:8}}>Deal Source Tracker</div>
            <div style={{fontSize:10,color:SL.muted,marginBottom:8}}>Where did this client come from? (Tracked for marketing ROI)</div>
            <div style={{display:"flex",flexDirection:"column",gap:4}}>
              {deals.slice(0,4).map(d=>(
                <div key={d.id} style={{display:"flex",gap:6,alignItems:"center",background:SL.bgSec,borderRadius:5,padding:"5px 8px"}}>
                  <span style={{fontSize:10,color:SL.text,flex:1,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{d.name}</span>
                  <select value={bizHealth.dealSources?.find(s=>s.id===d.id)?.source||""}
                    onChange={e=>{
                      const src=e.target.value;
                      setBizHealth(p=>({...p,dealSources:[...(p.dealSources||[]).filter(s=>s.id!==d.id),{id:d.id,name:d.name,value:d.value,source:src}]}));
                    }}
                    style={{background:SL.bgCard,border:`1px solid ${SL.border}`,borderRadius:4,padding:"2px 4px",fontSize:9,color:SL.muted,fontFamily:"inherit",cursor:"pointer"}}>
                    <option value="">Source?</option>
                    {["Referral","Instagram","Facebook","LinkedIn","TikTok","Google","PropertyGuru","Cold outreach","Existing client"].map(s=><option key={s} value={s}>{s}</option>)}
                  </select>
                </div>
              ))}
            </div>
...
// ── SOLO CUSTOMER ENGAGEMENT TAB ──────────────────────────────────────────────
function SoloEngagement({industry, contacts}){
  const allContacts=[...contacts,...industry.deals.map(d=>({id:d.id,name:d.name,phone:d.phone,type:d.type,note:d.note}))];
  const quickMessages=industry.id==="realtor"?[
    {label:"New listing alert",      ctx:`Alert ${industry.bizName}'s buyer clients about a relevant new property listing.`},
    {label:"Tenancy renewal nudge",  ctx:`Send a friendly tenancy renewal reminder from ${industry.bizName} to a landlord client whose lease expires soon.`},
    {label:"Market update",          ctx:`Send a brief property market update from ${industry.bizName} to keep clients engaged.`},
    {label:"Deal follow-up",         ctx:`Follow up on a property viewing or offer from ${industry.bizName}.`},
  ]:industry.id==="insurance"?[
    {label:"Annual review invite",   ctx:`Invite a client of ${industry.bizName} for their annual policy review.`},
    {label:"Renewal reminder",       ctx:`Send a warm policy renewal reminder from ${industry.bizName}.`},
    {label:"New product intro",      ctx:`Introduce a relevant new financial product to an existing client of ${industry.bizName}.`},
    {label:"Check-in message",       ctx:`Send a friendly check-in to a client who has not been contacted recently by ${industry.bizName}.`},
  ]:[
    {label:"Enquiry follow-up",       ctx:`Follow up on a design project enquiry for ${industry.bizName}. Warm, professional, move the conversation forward.`},
    {label:"Proposal follow-up",      ctx:`Follow up on a proposal sent by ${industry.bizName} that has not been responded to. Friendly nudge without being pushy.`},
    {label:"Project milestone update",ctx:`Send a progress update on an active design project from ${industry.bizName} to keep the client informed and confident.`},
    {label:"Invoice & handover",       ctx:`Send a professional project completion message from ${industry.bizName} with next steps for payment and handover.`},
  ];
  ...
  return(
    <div style={{flex:1,overflowY:"auto",padding:20,background:SL.bg,display:"flex",flexDirection:"column",gap:14}}>
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:14,alignItems:"start"}}>
        ...
        {/* Quick messages */}
        <div style={slcard()}>
          <div style={{fontSize:13,fontWeight:800,color:SL.text,marginBottom:4}}>Quick Message Templates</div>
          <div style={{fontSize:11,color:SL.muted,marginBottom:12}}>Generate · Edit · Open directly in WhatsApp with contact pre-selected</div>
          <div style={{display:"flex",flexDirection:"column",gap:8}}>
            {quickMessages.map((q,i)=>(
              <div key={i} style={{background:SL.bgSec,borderRadius:7,padding:"10px 12px",border:`1px solid ${SL.border}`}}>
                <div style={{fontSize:11,fontWeight:600,color:SL.text,marginBottom:4}}>💬 {q.label}</div>
                <SoloWhatsAppSend industry={industry} contacts={allContacts} context={q.ctx} label={q.label}/>
              </div>
            ))}
          </div>
        </div>
        ...
        {/* Custom message */}
        <div>
          <CustomSoloMessage industry={industry} contacts={allContacts}/>
        </div>
      </div>
    </div>
  );
...
function CustomSoloMessage({industry, contacts}){
  const[ctx,setCtx]=useState("");
  const[step,setStep]=useState("idle");
  const[msg,setMsg]=useState("");
  ...
  const generate=async()=>{
    ...
    setStep("generating");
    try{
      const system=`Write a WhatsApp message for ${industry.bizName}. Max 180 chars. Warm, personal. Return ONLY the message.`;
      const result=await callClaude([{role:"user",content:ctx}],system,false,"whatsapp");
      setMsg(result.text.trim());
      setStep("edit");
    }catch(e){
  ...
  const send=()=>{
    const url=sel ? `https://wa.me/${sel.phone}?text=${encodeURIComponent(msg)}` : `https://wa.me/?text=${encodeURIComponent(msg)}`;
    window.open(url,"_blank");
    setStep("done");
  };
  ...
  return(
    <div style={slcard()}>
      <div style={{fontSize:13,fontWeight:800,color:SL.text,marginBottom:4}}>Custom Message</div>
      <div style={{fontSize:11,color:SL.muted,marginBottom:12}}>Describe what you want to say — Aether writes it</div>

      {/* Contact selector */}
      <div style={{marginBottom:10}}>
        <div style={{fontSize:9,color:SL.muted,fontFamily:"'JetBrains Mono',monospace",letterSpacing:1,marginBottom:5}}>SEND TO</div>
        <div style={{display:"flex",gap:5,flexWrap:"wrap"}}>
          {contacts.slice(0,6).map(c=>(
            <button key={c.id} onClick={()=>setSel(sel?.id===c.id?null:c)}
              style={{fontSize:10,padding:"3px 9px",borderRadius:5,border:`1px solid ${sel?.id===c.id?"#25D166":SL.border}`,background:sel?.id===c.id?"rgba(37,209,102,0.12)":"transparent",color:sel?.id===c.id?"#25D166":SL.muted,cursor:"pointer",fontFamily:"inherit"}}>
              {c.name}
            </button>
          ))}
        </div>
        {sel&&<div style={{fontSize:9,color:"#25D166",marginTop:3,fontFamily:"'JetBrains Mono',monospace"}}>→ Opens WhatsApp chat with {sel.name}</div>}
      </div>

      {step!=="done"&&(
        <>
          <textarea value={ctx} onChange={e=>setCtx(e.target.value)} placeholder="Describe your message — e.g. 'Follow up on the 40-pax birthday catering quote I sent 3 days ago'" rows={3}
            style={{width:"100%",background:SL.bgSec,border:`1px solid ${SL.border}`,borderRadius:6,padding:"8px 10px",fontSize:11,color:SL.text,outline:"none",resize:"none",fontFamily:"inherit",lineHeight:1.5,marginBottom:8}}/>
          {step==="idle"&&<button onClick={generate} disabled={!ctx.trim()} style={{...slbtn(industry.color,{fontSize:11,padding:"7px 16px",opacity:!ctx.trim()?0.4:1})}}>Generate Message</button>}
          {step==="generating"&&<div style={{display:"flex",gap:4,padding:"8px 0"}}>{[0,1,2].map(i=><div key={i} style={{width:5,height:5,borderRadius:"50%",background:industry.color,animation:`bounce 1.1s infinite ${i*0.18}s`}}/>)}</div>}
          {step==="edit"&&(
            <>
              <textarea value={msg} onChange={e=>setMsg(e.target.value)} rows={4}
                style={{width:"100%",background:SL.bgSec,border:"1px solid rgba(37,209,102,0.3)",borderRadius:6,padding:"8px 10px",fontSize:11,color:SL.text,outline:"none",resize:"none",fontFamily:"inherit",lineHeight:1.5,marginBottom:6}}/>
              <div style={{display:"flex",gap:8}}>
                <button onClick={send} style={{...slbtn("#25D166",{fontSize:11,padding:"7px 14px",flex:1,justifyContent:"center"})}}>💬 Open WhatsApp{sel?` → ${sel.name}`:""}</button>
                <button onClick={()=>setStep("idle")} style={{fontSize:11,color:SL.muted,background:"none",border:"none",cursor:"pointer"}}>✕</button>
              </div>
            </>
          )}
        </>
      ...
      {step==="done"&&(
        <div style={{textAlign:"center",padding:"12px 0"}}>
          ...
          <div style={{fontSize:11,color:SL.text,marginBottom:8}}>WhatsApp opened — tap Send to deliver</div>
          <button onClick={()=>{setStep("idle");setMsg("");setCtx("");}} style={{fontSize:10,color:industry.color,background:"none",border:`1px solid ${industry.color}40`,borderRadius:5,padding:"5px 12px",cursor:"pointer",fontFamily:"inherit"}}>New Message</button>
        </div>
      )}
    </div>
  );
...
// ── SOLO CALENDAR TAB ─────────────────────────────────────────────────────────
function SoloCalendar({industry}){
  const items=industry.calendarItems;
  const typeColor={viewing:SL.tealL,deadline:SL.red,expiry:SL.amber,followup:SL.blue,review:SL.gold,meeting:SL.purple,delivery:SL.green};
  const typeIcon={viewing:"🏠",deadline:"⚠️",expiry:"⏰",followup:"📞",review:"📋",meeting:"🤝",delivery:"📦"};
  ...
  return(
    <div style={{flex:1,overflowY:"auto",padding:20,background:SL.bg,display:"flex",flexDirection:"column",gap:14}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:14,alignItems:"start"}}>
        {/* Calendar items */}
        <div style={slcard()}>
          <div style={{fontSize:13,fontWeight:800,color:SL.text,marginBottom:4}}>Upcoming Dates</div>
          <div style={{fontSize:11,color:SL.muted,marginBottom:12}}>Add any item directly to Google Calendar or download as .ics for Apple Calendar</div>
          <div style={{display:"flex",flexDirection:"column",gap:8}}>
            {sorted.map((item,i)=>{
              const c=typeColor[item.type]||SL.dim;
              return(
                <div key={i} style={{background:SL.bgSec,borderRadius:8,border:`1px solid ${SL.border}`,overflow:"hidden"}}>
                    ...
                    <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",gap:8}}>
                      <div style={{flex:1}}>
                        <div style={{display:"flex",alignItems:"center",gap:6,marginBottom:4,flexWrap:"wrap"}}>
                          ...
                          <span style={{fontSize:11,fontWeight:700,color:SL.text}}>{item.title}</span>
                        </div>
                        <div style={{display:"flex",gap:8,alignItems:"center",flexWrap:"wrap"}}>
                          <span style={{fontSize:10,fontFamily:"'JetBrains Mono',monospace",color:SL.muted}}>{item.date}{item.time?` · ${item.time}`:""}</span>
                          <span style={sltag(c)}>{item.type.toUpperCase()}</span>
                          <span style={{fontSize:10,color:SL.dim}}>{item.contact}</span>
                        </div>
                      </div>
                    </div>
                    {/* Calendar export buttons */}
                    <div style={{display:"flex",gap:6,marginTop:8}}>
                      <a href={googleCalLink(item)} target="_blank" rel="noopener noreferrer"
                        style={{display:"inline-flex",alignItems:"center",gap:4,fontSize:10,padding:"4px 10px",borderRadius:5,border:"1px solid rgba(66,133,244,0.4)",background:"rgba(66,133,244,0.1)",color:"#4285F4",textDecoration:"none",fontFamily:"inherit",fontWeight:600}}>
                        📅 Google Calendar
                      </a>
                      <button onClick={()=>downloadICS(item,industry.bizName)}
                        style={{display:"inline-flex",alignItems:"center",gap:4,fontSize:10,padding:"4px 10px",borderRadius:5,border:`1px solid ${SL.border}`,background:"transparent",color:SL.muted,cursor:"pointer",fontFamily:"inherit"}}>
                        🍎 Export .ics
                      </button>
                    </div>
                  </div>
        ...
        <div>
          <div style={slcard()}>
            <div style={{fontSize:12,fontWeight:800,color:SL.text,marginBottom:8}}>How Calendar Sync Works</div>
            {[
              {icon:"📅",title:"Google Calendar",body:"Tap 'Google Calendar' — opens Google Calendar in your browser with the event pre-filled. One click to save. Syncs to your phone automatically if Google Calendar is set up."},
              {icon:"🍎",title:"Apple Calendar (.ics)",body:"Tap 'Export .ics' — downloads a calendar file. Open it on your iPhone or Mac and it imports directly into Apple Calendar or any calendar app."},
              {icon:"📱",title:"Syncs to your phone",body:"Once added to Google or Apple Calendar, the event appears on your phone immediately — with notifications, reminders, and location if you add them."},
            ].map((s,i)=>(
              <div key={i} style={{display:"flex",gap:10,padding:"8px 0",borderBottom:i<2?`1px solid ${SL.border}`:"none"}}>
                <span style={{fontSize:18,flexShrink:0}}>{s.icon}</span>
                <div>
                  <div style={{fontSize:11,fontWeight:700,color:SL.text,marginBottom:2}}>{s.title}</div>
                  <div style={{fontSize:10,color:SL.muted,lineHeight:1.5}}>{s.body}</div>
                </div>
              </div>
            ))}
          </div>

          <div style={{...slcard(),marginTop:12,background:`${industry.color}08`,border:`1px solid ${industry.color}20`}}>
            <div style={{fontSize:11,fontWeight:700,color:industry.color,marginBottom:6}}>Add a Custom Date</div>
            <CustomCalendarEntry industry={industry}/>
          </div>
        </div>
      </div>
    </div>
...
function CustomCalendarEntry({industry}){
  const[form,setForm]=useState({title:"",date:"",time:"",contact:""});
  ...
  if(added) return(
    <div>
      <div style={{fontSize:11,color:SL.green,marginBottom:8}}>✓ {form.title} added</div>
      <div style={{display:"flex",gap:6}}>
        <a href={googleCalLink({...form,type:"custom",contact:form.contact})} target="_blank" rel="noopener noreferrer"
          style={{fontSize:10,padding:"4px 10px",borderRadius:5,border:"1px solid rgba(66,133,244,0.4)",background:"rgba(66,133,244,0.1)",color:"#4285F4",textDecoration:"none",fontFamily:"inherit"}}>
          📅 Add to Google Calendar
        </a>
        <button onClick={()=>downloadICS({...form,type:"custom",contact:form.contact},industry.bizName)}
          style={{fontSize:10,padding:"4px 10px",borderRadius:5,border:`1px solid ${SL.border}`,background:"transparent",color:SL.muted,cursor:"pointer",fontFamily:"inherit"}}>
          🍎 Export .ics
        </button>
      </div>
      <button onClick={()=>{setAdded(false);setForm({title:"",date:"",time:"",contact:""}); }} style={{marginTop:6,fontSize:10,color:SL.muted,background:"none",border:"none",cursor:"pointer"}}>+ Another</button>
    </div>
  );
  return(
    <div style={{display:"flex",flexDirection:"column",gap:6}}>
      {[
        {key:"title",ph:"Event title *"},
        {key:"date", ph:"Date (YYYY-MM-DD) *"},
        {key:"time", ph:"Time (HH:MM) optional"},
        {key:"contact",ph:"Contact name"},
      ].map(f=>(
        <input key={f.key} value={form[f.key]} onChange={e=>setForm(p=>({...p,[f.key]:e.target.value}))}
          placeholder={f.ph} style={{background:SL.bgCard,border:`1px solid ${SL.border}`,borderRadius:5,padding:"6px 8px",fontSize:10,color:SL.text,outline:"none",fontFamily:"inherit"}}/>
      ))}
      <button onClick={submit} disabled={!form.title||!form.date} style={{...slbtn(industry.color,{fontSize:10,padding:"6px",justifyContent:"center",opacity:!form.title||!form.date?0.4:1})}}>Generate Calendar Links</button>
    </div>
  );
}
...
// ── SOLO KPI DASHBOARD ────────────────────────────────────────────────────────
function SoloDashboard({industry, bizHealth, weeklyDigest, setWeeklyDigest}){
  const[generating,setGenerating]=useState(false);

  const confirmed = industry.deals.filter(d=>d.stage==="Confirmed"||d.stage==="In Progress"||d.stage==="Delivered"||d.stage==="Closed Won").reduce((s,d)=>s+toNum(d.value),0);
  const atRisk    = industry.deals.filter(d=>d.heat==="medium"&&(d.stage==="Quote Sent"||d.stage==="Proposal Sent")).reduce((s,d)=>s+toNum(d.value),0);
  const fullPipe  = industry.deals.reduce((s,d)=>s+toNum(d.value),0);
  const cur       = industry.currency;

  const generateDigest=async()=>{
    setGenerating(true);
    const totalSpend=(bizHealth.expenses||[]).reduce((s,e)=>s+e.amount,0);
    const mktSpend=(bizHealth.expenses||[]).filter(e=>e.cat==="marketing").reduce((s,e)=>s+e.amount,0);
    const topSource=(()=>{
      const src={};
      (bizHealth.dealSources||[]).forEach(ds=>{src[ds.source]=(src[ds.source]||0)+1;});
      return Object.entries(src).sort((a,b)=>b[1]-a[1])[0]?.[0]||"Referral";
    })();

    const system=`You are Aether Solo — a business intelligence co-pilot for ${industry.bizName}, a ${industry.role} in ${industry.location}.

Generate a concise Monday morning business brief. Tone: direct, specific, like a trusted advisor who knows the business deeply. Format with exactly 3 sections:

**This Week in Numbers** — 2-3 bullet points with real data
**What's Working** — one specific insight about what generated the best return
**Your One Priority This Week** — one specific action, referencing actual deal names

Keep total length under 220 words. Be specific — mention actual deal names, amounts, channels. No generic advice.`;

    const ctx=`Business data:
Pipeline: ${industry.deals.map(d=>`${d.name} (${d.stage}, ${d.heat} heat, ${d.value})`).join(" | ")}
Revenue confirmed: ${cur}${confirmed.toLocaleString()} | At risk: ${cur}${atRisk.toLocaleString()} | Full pipeline: ${cur}${fullPipe.toLocaleString()}
Total expenses this month: ${cur}${totalSpend} | Marketing spend: ${cur}${mktSpend}
Top client source: ${topSource}
Hot deals needing action: ${industry.deals.filter(d=>d.heat==="high").map(d=>d.name).join(", ")||"none"}`;

    try{
      const result=await callClaude([{role:"user",content:ctx}],system,false,"digest");
      setWeeklyDigest(result.text);
    }catch(e){
      setWeeklyDigest("Add VITE_ANTHROPIC_KEY in Vercel to generate your weekly digest.");
    }
    setGenerating(false);
  };
  ...
  return(
    <div style={{flex:1,overflowY:"auto",padding:20,background:SL.bg,display:"flex",flexDirection:"column",gap:14}}>
      ...
      {/* KPI grid */}
      <div>
        <div style={{fontSize:11,fontWeight:700,color:SL.muted,marginBottom:8,textTransform:"uppercase",letterSpacing:2,fontFamily:"'JetBrains Mono',monospace"}}>My Numbers — This Month</div>
        <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:10}}>
          {industry.kpis.map(k=>(
            <div key={k.label} style={{...slcard(),position:"relative",overflow:"hidden"}}>
              <div style={{position:"absolute",top:0,left:0,right:0,height:3,background:`linear-gradient(90deg,${industry.color},transparent)`}}/>
              <div style={{fontSize:9,fontWeight:700,color:SL.muted,letterSpacing:1.5,textTransform:"uppercase",fontFamily:"'JetBrains Mono',monospace",marginBottom:5}}>{k.label}</div>
              <div style={{fontSize:22,fontWeight:800,color:SL.text,letterSpacing:-0.5,marginBottom:2}}>{k.value}</div>
              <span style={{fontSize:11,fontWeight:700,color:k.pos?SL.green:SL.red,fontFamily:"'JetBrains Mono',monospace"}}>{k.change}</span>
              <div style={{fontSize:10,color:SL.dim,marginTop:3}}>{k.sub}</div>
            </div>
          ))}
        </div>
      </div>
      ...
      {/* Income forecast bar */}
      <div style={{...slcard(),background:"#080c18",border:`1px solid ${SL.border}`}}>
        <div style={{fontSize:10,letterSpacing:2,textTransform:"uppercase",fontFamily:"'JetBrains Mono',monospace",color:"rgba(255,255,255,0.4)",marginBottom:10}}>Income Forecast — Forward Looking</div>
        <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:12}}>
          {[
            {label:"Confirmed",    val:confirmed, c:"34d399", sub:"High-probability deals"},
            {label:"At Risk",      val:atRisk,    c:"f59e0b", sub:"Quoted · awaiting decision"},
            {label:"Full Pipeline",val:fullPipe,  c:"60a5fa", sub:"If all deals close"},
            {label:"Target",       val:toNum(industry.kpis[0].value), c:SL.gold, sub:"Monthly income goal"},
          ].map(s=>(
            <div key={s.label}>
              <div style={{fontSize:20,fontWeight:900,color:`#${s.c}`,letterSpacing:-0.5,fontFamily:"'JetBrains Mono',monospace"}}>{cur}{s.val.toLocaleString()}</div>
              <div style={{fontSize:9,color:"rgba(255,255,255,0.45)",marginTop:2,textTransform:"uppercase",letterSpacing:1,fontFamily:"'JetBrains Mono',monospace"}}>{s.label}</div>
      ...
      {/* Hot leads + weekly digest side by side */}
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:14,alignItems:"start"}}>

        {/* Hot leads */}
        <div style={slcard()}>
          <div style={{fontSize:12,fontWeight:800,color:SL.text,marginBottom:10}}>⚡ Needs Action Today</div>
          <div style={{display:"flex",flexDirection:"column",gap:6}}>
            {industry.deals.filter(d=>d.heat==="high").length===0&&(
              <div style={{fontSize:11,color:SL.muted,textAlign:"center",padding:"12px 0"}}>No hot deals — good position</div>
            )}
            {industry.deals.filter(d=>d.heat==="high").map(d=>(
              <div key={d.id} style={{background:SL.bgSec,borderRadius:7,padding:"10px 12px",border:`1px solid ${SL.red}25`}}>
                <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start"}}>
                  <div style={{flex:1}}>
                    <div style={{fontSize:11,fontWeight:700,color:SL.text,marginBottom:2}}>{d.name} <span style={{...sltag(SL.red),marginLeft:4,fontWeight:800}}>HOT</span></div>
                    <div style={{fontSize:10,color:SL.muted,lineHeight:1.5}}>{d.note.slice(0,80)}{d.note.length>80?"...":""}</div>
                    <div style={{fontSize:9,color:SL.amber,marginTop:4,fontFamily:"'JetBrains Mono',monospace"}}>Due: {d.due} · Last contact: {d.lastContact}d ago</div>
                  </div>
                  <div style={{fontSize:13,fontWeight:800,color:industry.color,fontFamily:"'JetBrains Mono',monospace",marginLeft:10,flexShrink:0}}>{d.value}</div>
                </div>
              </div>
            ))}
          </div>
        ...
        <div style={slcard()}>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8}}>
            <div>
              <div style={{fontSize:12,fontWeight:800,color:SL.text}}>🧠 Weekly Digest</div>
              <div style={{fontSize:10,color:SL.muted}}>Your Monday morning brief from Aether</div>
            </div>
            <button onClick={generateDigest} disabled={generating} style={{...slbtn(industry.color,{fontSize:10,padding:"5px 12px",opacity:generating?0.6:1})}}>
              {generating?"Generating...":"Generate"}
            </button>
          </div>
          {weeklyDigest?(
            <div style={{background:SL.bgSec,borderRadius:7,padding:"10px 12px",fontSize:10.5,color:SL.muted,lineHeight:1.7}}>
              <Md text={weeklyDigest}/>
            </div>
          ):(
            <div style={{background:SL.bgSec,borderRadius:7,padding:"16px 12px",textAlign:"center"}}>
              <div style={{fontSize:28,marginBottom:8}}>📋</div>
              <div style={{fontSize:11,color:SL.muted,marginBottom:4}}>Click Generate to get your weekly brief</div>
              <div style={{fontSize:10,color:SL.dim,fontStyle:"italic"}}>Aether analyses your pipeline, expenses, and marketing data to give you one clear priority for the week</div>
            </div>
          )}
        </div>
      </div>
...
function SoloCopilot({industry}){
  ...
  const processFiles=async(rawFiles)=>{
    ...
    for(const f of arr){
      try{
        if(/\.(xlsx|xls)$/i.test(f.name)){const t=await readExcel(f);parsed.push({name:f.name,type:"excel",content:t,size:f.size});}
        else if(/\.csv$/i.test(f.name)){const t=await readCsv(f);parsed.push({name:f.name,type:"csv",content:t,size:f.size});}
        else{const b=await readPdf(f);parsed.push({name:f.name,type:"pdf",content:b,size:f.size});}
      }catch(e){console.error(e);}
    }
    if(!parsed.length)return;
    setAllFiles(p=>[...p,...parsed]);
  ...
  const welcomeMsg=`## Hi ${industry.bizName}! I'm your Aether Co-Pilot 👋\n\nI know your business — ${industry.role}, ${industry.location}.\n\n**Pipeline:** ${industry.deals.length} active deals · **MTD:** ${industry.kpis[0].value}\n\nAsk me anything about your pipeline, clients, or income — or upload a file for deeper analysis.`;

  return(
    <div style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden",background:SL.bg}}>
      {/* File upload */}
      <div style={{padding:"10px 20px",borderBottom:`1px solid ${SL.border}`,background:SL.bgCard,flexShrink:0}}>
        <div onDrop={e=>{e.preventDefault();setDragOver(false);processFiles(e.dataTransfer.files);}} onDragOver={e=>{e.preventDefault();setDragOver(true);}} onDragLeave={()=>setDragOver(false)} onClick={()=>fileRef.current?.click()}
          style={{background:dragOver?T.primaryDim:SL.bgSec,border:`1.5px dashed ${dragOver?T.primary:SL.border}`,borderRadius:8,padding:"10px 16px",cursor:"pointer",transition:"all 0.15s"}}>
          <input ref={fileRef} type="file" multiple accept=".xlsx,.xls,.pdf,.csv" style={{display:"none"}} onChange={e=>processFiles(e.target.files)}/>
          <div style={{display:"flex",alignItems:"center",gap:12}}>
            <div style={{width:30,height:30,borderRadius:7,background:T.primaryDim,display:"flex",alignItems:"center",justifyContent:"center",fontSize:16,fontWeight:700,color:T.primary,flexShrink:0}}>+</div>
            <div style={{flex:1}}>
              <div style={{fontSize:12,fontWeight:600,color:SL.text,marginBottom:1}}>Add External Data</div>
              <div style={{fontSize:10,fontFamily:"'JetBrains Mono',monospace",color:SL.muted}}>Drop or click · Excel · CSV · PDF</div>
            </div>
            {allFiles.length>0&&<span style={sltag(SL.green)}>{allFiles.length} FILE{allFiles.length>1?"S":""} LOADED</span>}
          </div>
        </div>
      </div>
      {/* Quick questions */}
      <div style={{padding:"10px 20px",borderBottom:`1px solid ${SL.border}`,background:SL.bgCard,flexShrink:0}}>
        <div style={{fontSize:11,fontWeight:700,color:SL.text,marginBottom:6}}>Quick Questions</div>
        <div style={{display:"flex",gap:7,flexWrap:"wrap"}}>
          {industry.questions.map((q,i)=>(
            <button key={i} onClick={()=>setActiveQ(q)}
              style={{fontSize:11,padding:"5px 12px",borderRadius:20,border:`1px solid ${SL.border}`,background:SL.bgSec,color:SL.muted,cursor:"pointer",transition:"all 0.15s",fontFamily:"inherit"}}
              onMouseEnter={e=>{e.currentTarget.style.borderColor=industry.color;e.currentTarget.style.color=industry.color;}}
              onMouseLeave={e=>{e.currentTarget.style.borderColor=SL.border;e.currentTarget.style.color=SL.muted;}}>
              {q}
            </button>
          ))}
        </div>
      ...
      <div style={{flex:1,padding:20,overflow:"hidden",display:"flex",flexDirection:"column"}}>
        <SoloChatBox industry={industry} initialMsg={activeQ?`## ${activeQ}\n\nLet me look at your pipeline data...`:welcomeMsg} pendingFiles={pending} setPending={setPending}/>
      </div>
    </div>
  );
}

function SoloChatBox({industry, initialMsg, pendingFiles=[], setPending}){
  const[messages,setMessages]=useState([{role:"assistant",content:initialMsg}]);
  const[input,setInput]=useState("");
  const[loading,setLoading]=useState(false);
  const endRef=useRef(null);
  ...
  const send=async(text)=>{
    ...
    const userText=text||input.trim();
    if(!userText&&!hasFiles||loading)return;
    const msgText=userText||(hasFiles?"Analyse the uploaded files and give me specific recommendations.":"");
    setInput("");
    setMessages(p=>[...p,{role:"user",content:msgText}]);
    setLoading(true);

    const expenses=bizHealth.expenses||[];
    const dealSources=bizHealth.dealSources||[];
    const totalSpend=expenses.reduce((s,e)=>s+e.amount,0);
    const mktSpend=expenses.filter(e=>e.cat==="marketing").reduce((s,e)=>s+e.amount,0);
    const revenue=toNum(industry.kpis[0].value)||0;
    const channels={};
    dealSources.forEach(ds=>{if(ds.source){if(!channels[ds.source])channels[ds.source]={clients:0,revenue:0};channels[ds.source].clients++;channels[ds.source].revenue+=toNum(ds.value||"0");}});
    const channelSummary=Object.entries(channels).map(([ch,d])=>`${ch}: ${d.clients} clients, ${industry.currency}${d.revenue} revenue`).join(" | ")||"No channel data yet";

    const system=`You are Aether Solo — a plain-English sales intelligence co-pilot for ${industry.bizName}, a ${industry.role} in ${industry.location}.

PIPELINE:
${industry.deals.map(d=>`${d.name} (${d.stage}, ${d.heat} heat, last contact ${d.lastContact}d ago, value ${d.value}): ${d.note}`).join("\n")}

BUSINESS PERFORMANCE:
Revenue MTD: ${industry.kpis[0].value} | Net profit est: ${industry.currency}${(revenue-totalSpend).toLocaleString()}
Total expenses: ${industry.currency}${totalSpend} | Marketing spend: ${industry.currency}${mktSpend} (${revenue>0?((mktSpend/revenue)*100).toFixed(1):0}% of revenue)
Marketing channel ROI: ${channelSummary}

HOT DEALS: ${industry.deals.filter(d=>d.heat==="high").map(d=>d.name).join(", ")||"none"}

INSTRUCTIONS:
Give direct, specific, quantified answers. Always reference actual deal names, amounts, and channel data from their business. When asked about marketing, reference their actual channel ROI. When asked about income, use their real pipeline numbers. Recommend the single best action they can take today. Keep under 220 words. Plain English, no jargon.`;

    const history=messages.slice(-8).map(m=>({role:m.role,content:String(m.content)}));
    const userContent=[];
    for(const f of pendingFiles){
      if(f.type==="pdf") userContent.push({type:"document",source:{type:"base64",media_type:"application/pdf",data:f.content}});
      else userContent.push({type:"text",text:`=== ${f.name} ===\n${f.content}`});
    }
    userContent.push({type:"text",text:msgText});
  ...
  return(
    <div style={{display:"flex",flexDirection:"column",flex:1,background:SL.bgCard,border:`1px solid ${SL.border}`,borderRadius:10,overflow:"hidden"}}>
      <div style={{flex:1,overflowY:"auto",padding:14,display:"flex",flexDirection:"column",gap:8}}>
        {messages.map((m,i)=>(
          <div key={i} style={{display:"flex",justifyContent:m.role==="user"?"flex-end":"flex-start"}}>
            {m.role==="assistant"&&<div style={{width:22,height:22,borderRadius:"50%",background:`linear-gradient(135deg,${industry.color},${SL.tealL})`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:9,fontWeight:800,color:"#fff",flexShrink:0,marginRight:6,marginTop:2}}>A</div>}
            <div style={{maxWidth:"85%",padding:"8px 11px",borderRadius:m.role==="user"?"7px 2px 7px 7px":"2px 7px 7px 7px",fontSize:11,lineHeight:1.6,background:m.role==="user"?industry.color:SL.bgSec,color:m.role==="user"?"#fff":SL.text,border:m.role==="assistant"?`1px solid ${SL.border}`:"none"}}>
              <Md text={m.content}/>
            </div>
          </div>
        ))}
        {loading&&<div style={{display:"flex",gap:4,padding:"8px 11px",background:SL.bgSec,borderRadius:"2px 7px 7px 7px",width:"fit-content"}}>{[0,1,2].map(i=><div key={i} style={{width:4,height:4,borderRadius:"50%",background:industry.color,animation:`bounce 1.1s infinite ${i*0.18}s`}}/>)}</div>}
        <div ref={endRef}/>
      </div>
      {pendingFiles.length>0&&(
        <div style={{padding:"4px 10px",display:"flex",gap:5,flexWrap:"wrap",background:SL.bgSec}}>
          {pendingFiles.map((f,i)=>(
            <div key={i} style={{display:"flex",alignItems:"center",gap:4,background:T.primaryDim,border:`1px solid ${T.primary}40`,borderRadius:4,padding:"2px 7px"}}>
              <span style={{fontSize:10}}>{f.type==="pdf"?"📄":"📊"}</span>
              <span style={{fontSize:9,fontFamily:"'JetBrains Mono',monospace",color:T.primary}}>{f.name}</span>
              {setPending&&<button onClick={()=>setPending(p=>p.filter((_,j)=>j!==i))} style={{background:"none",border:"none",color:SL.muted,cursor:"pointer",fontSize:11,padding:0}}>×</button>}
            </div>
          ))}
        </div>
      )}
      <div style={{padding:8,borderTop:`1px solid ${SL.border}`,display:"flex",gap:6}}>
        <input value={input} onChange={e=>setInput(e.target.value)} onKeyDown={e=>e.key==="Enter"&&send()}
          placeholder={pendingFiles.length?"Files ready — ask anything or press Send...":"Ask anything about your pipeline or income..."}
          style={{flex:1,background:SL.bg,border:`1px solid ${SL.border}`,borderRadius:6,padding:"7px 10px",fontSize:11,color:SL.text,outline:"none",fontFamily:"inherit"}}/>
        <button onClick={()=>send()} disabled={loading||(!input.trim()&&!pendingFiles.length)} style={{...slbtn(industry.color,{padding:"7px 12px",opacity:loading?0.5:1})}}>➤</button>
      </div>
    </div>
  );
}
// ── SOLO APP ──────────────────────────────────────────────────────────────────
// ── SOLO BUSINESS HEALTH TAB ──────────────────────────────────────────────────
function SoloBusinessHealth({industry, bizHealth, setBizHealth}){
  const STORAGE_KEY=`aether_solo_expenses_${industry.id}`;
  const SNAPSHOTS_KEY=`aether_solo_snapshots_${industry.id}`;

  // ── State ────────────────────────────────────────────────────────────────
  const[allExpenses,setAllExpenses]=useState([]);
  const[snapshots,setSnapshots]=useState([]);
  const[loaded,setLoaded]=useState(false);
  const[activeMonth,setActiveMonth]=useState(new Date().toISOString().slice(0,7)); // "2026-04"
  ...
  const CATS=[
    {id:"marketing",  label:"Marketing & Advertising",  ded:100, color:SL.tealL},
    {id:"tools",      label:"Software & Subscriptions", ded:100, color:SL.purple},
    {id:"transport",  label:"Transport & Travel",        ded:100, color:SL.blue},
    {id:"entertainment",label:"Client Entertainment",   ded:50,  color:SL.amber, flag:"50% deductible"},
    {id:"professional",label:"Professional Services",   ded:100, color:SL.green},
    {id:"development",label:"Professional Development", ded:100, color:SL.tealL},
    {id:"equipment",  label:"Equipment",                ded:100, color:SL.muted},
    {id:"other",      label:"Other Operating",          ded:100, color:SL.dim},
  ];
  const catMap=Object.fromEntries(CATS.map(c=>[c.id,c]));
  ...
  useEffect(()=>{
    try{
      ...
      const r2=localStorage.getItem(SNAPSHOTS_KEY);
      if(r1) setAllExpenses(JSON.parse(r1));
      if(r2) setSnapshots(JSON.parse(r2));
    }catch(e){}
    setLoaded(true);
  },[industry.id]);
  ...
  const saveExpenses=(exps)=>{
    setAllExpenses(exps);
    setBizHealth(p=>({...p,expenses:exps.filter(e=>e.date.slice(0,7)===activeMonth)}));
    try{localStorage.setItem(STORAGE_KEY,JSON.stringify(exps));}catch(e){}
  };
  const saveSnapshots=(snaps)=>{
    setSnapshots(snaps);
  ...
  // ── Sync current-month expenses into bizHealth for Co-Pilot ──────────────
  useEffect(()=>{
    if(!loaded) return;
    const monthExps=allExpenses.filter(e=>e.date.slice(0,7)===activeMonth);
    setBizHealth(p=>({...p,expenses:monthExps}));
  },[allExpenses, activeMonth, loaded]);

  // ── Computed values ───────────────────────────────────────────────────────
  const monthExps  = allExpenses.filter(e=>e.date.slice(0,7)===activeMonth);
  const ytdExps    = allExpenses.filter(e=>e.date.startsWith(activeMonth.slice(0,4)));
  const dealSources= bizHealth.dealSources||[];
  const cur        = industry.currency;

  const totalMonth = monthExps.reduce((s,e)=>s+e.amount,0);
  const totalYTD   = ytdExps.reduce((s,e)=>s+e.amount,0);
  const deductYTD  = ytdExps.reduce((s,e)=>s+e.amount*(catMap[e.cat]?.ded||100)/100,0);
  const revenue    = toNum(industry.kpis[0].value)||0;
  const mktSpend   = monthExps.filter(e=>e.cat==="marketing").reduce((s,e)=>s+e.amount,0);
  const mktPct     = revenue>0?((mktSpend/revenue)*100).toFixed(1):0;
  const netProfit  = revenue-totalMonth;

  // Channel attribution (feeds existing Marketing ROI table)
  const channels={};
  dealSources.forEach(ds=>{
    if(!ds.source)return;
    if(!channels[ds.source])channels[ds.source]={clients:0,revenue:0};
    channels[ds.source].clients++;
    channels[ds.source].revenue+=toNum(ds.value||"0");
  });
  const channelSpend={};
  monthExps.filter(e=>e.cat==="marketing").forEach(e=>{
    const ch=e.label.toLowerCase().includes("instagram")?"Instagram":
              e.label.toLowerCase().includes("facebook")?"Facebook":
              e.label.toLowerCase().includes("linkedin")?"LinkedIn":
              e.label.toLowerCase().includes("tiktok")?"TikTok":
              e.label.toLowerCase().includes("google")?"Google":e.label;
    channelSpend[ch]=(channelSpend[ch]||0)+e.amount;
  });

  // Available months with data
  const monthsWithData=[...new Set(allExpenses.map(e=>e.date.slice(0,7)))].sort().reverse();
  if(!monthsWithData.includes(activeMonth)) monthsWithData.unshift(activeMonth);

  const fmtMonth=(ym)=>{
    const [y,m]=ym.split("-");
    return new Date(+y,+m-1).toLocaleDateString("en-SG",{month:"short",year:"numeric"});
  };

  // ── Add expense ───────────────────────────────────────────────────────────
  const addExpense=()=>{
    if(!expInput.trim()||!expAmount) return;
    const e={id:`e-${Date.now()}`,label:expInput.trim(),amount:parseFloat(expAmount)||0,
              cat:expCat,date:expDate,note:expNote.trim()};
    saveExpenses([...allExpenses,e]);
    setExpInput(""); setExpAmount(""); setExpNote(""); setExpCat("marketing");
  };
  ...
  const exportCSV=()=>{
    ...
    ytdExps.sort((a,b)=>a.date.localeCompare(b.date)).forEach(e=>{
      const cat=catMap[e.cat];
      rows.push(`${e.date},"${e.label}","${cat?.label||e.cat}",${e.amount},${cat?.ded||100}%,"${e.note||""}"`);
    });
    rows.push("");
    rows.push(`"YTD Total Spend",,,${totalYTD.toFixed(2)},,`);
    rows.push(`"Estimated Deductible Amount",,,${deductYTD.toFixed(2)},,`);
    rows.push(`"","For reference only — consult a tax professional for your actual IRAS filing",,,,`);
    const blob=new Blob([rows.join("\n")],{type:"text/csv"});
    const url=URL.createObjectURL(blob);
    const a=document.createElement("a");
    a.href=url;
    a.download=`${year}_Business_Expenses_${industry.bizName.split(" ").join("_")}.csv`;
    a.click(); URL.revokeObjectURL(url);
  };
  ...
  const closeMonth=async()=>{
    setClosingMonth(true);
    const system=`You are Aether Solo. Write a concise monthly business review for ${industry.bizName} (${industry.role}).
Format as 3 short sections with headers: **Revenue & Pipeline**, **Expenses & Profitability**, **Key Takeaway for Next Month**.
Max 180 words total. Be specific — use real numbers. Tone: like a trusted advisor reviewing the month with the owner.`;
    const ctx=`Month: ${fmtMonth(activeMonth)}
Revenue: ${cur}${revenue.toLocaleString()} | Expenses: ${cur}${totalMonth.toLocaleString()} | Net profit: ${cur}${netProfit.toLocaleString()} | Marketing spend: ${cur}${mktSpend} (${mktPct}% of revenue)
Expenses by category: ${CATS.map(c=>{const t=monthExps.filter(e=>e.cat===c.id).reduce((s,e)=>s+e.amount,0);return t>0?`${c.label}: ${cur}${t}`:null;}).filter(Boolean).join(", ")||"No expenses logged"}
Top marketing channels: ${Object.entries(channels).map(([ch,d])=>`${ch} (${d.clients} clients, ${cur}${d.revenue})`).join(", ")||"No source data"}
Pipeline deals: ${industry.deals.length} active | Hot deals: ${industry.deals.filter(d=>d.heat==="high").length}`;
    let summary="";
    try{
      const r=await callClaude([{role:"user",content:ctx}],system,false,"snapshot");
      summary=r.text;
    }catch(e){
      summary=`**Revenue & Pipeline**\nRevenue: ${cur}${revenue.toLocaleString()} · Net profit: ${cur}${netProfit.toLocaleString()} · ${industry.deals.filter(d=>d.heat==="high").length} hot deals active.\n\n**Expenses & Profitability**\nTotal expenses: ${cur}${totalMonth.toLocaleString()} · Marketing: ${cur}${mktSpend} (${mktPct}% of revenue).\n\n**Key Takeaway**\nAdd VITE_ANTHROPIC_KEY to generate AI-written monthly review.`;
    }
    const snap={id:activeMonth,month:activeMonth,label:fmtMonth(activeMonth),summary,
                revenue,expenses:totalMonth,netProfit,mktSpend,expCount:monthExps.length,
                closedAt:new Date().toISOString()};
    const updated=[...snapshots.filter(s=>s.id!==activeMonth),snap].sort((a,b)=>b.id.localeCompare(a.id));
  ...
  if(!loaded) return <div style={{flex:1,display:"flex",alignItems:"center",justifyContent:"center",background:SL.bg}}><div style={{color:SL.muted,fontSize:13}}>Loading...</div></div>;
  ...
  return(
    <div style={{flex:1,overflowY:"auto",padding:20,background:SL.bg,display:"flex",flexDirection:"column",gap:14}}>
      ...
      <div style={{display:"flex",gap:8,alignItems:"center",flexWrap:"wrap"}}>
        <span style={{fontSize:10,color:SL.muted,fontFamily:"'JetBrains Mono',monospace",letterSpacing:1}}>MONTH:</span>
        {monthsWithData.slice(0,6).map(m=>(
          <button key={m} onClick={()=>setActiveMonth(m)} style={{fontSize:11,padding:"5px 12px",borderRadius:20,border:`1.5px solid ${activeMonth===m?industry.color:SL.border}`,background:activeMonth===m?`${industry.color}15`:"transparent",color:activeMonth===m?industry.color:SL.muted,cursor:"pointer",fontFamily:"inherit",fontWeight:activeMonth===m?700:400}}>
            {fmtMonth(m)}{snapshots.find(s=>s.id===m)?" ✓":""}
          </button>
        ))}
        <div style={{marginLeft:"auto",display:"flex",gap:6}}>
          <button onClick={exportCSV} style={{...slbtn(SL.green,{fontSize:10,padding:"5px 12px"})}}>↓ Export CSV</button>
          <button onClick={closeMonth} disabled={closingMonth||!!thisSnap} style={{...slbtn(industry.color,{fontSize:10,padding:"5px 12px",opacity:closingMonth||thisSnap?0.5:1})}}>
            {closingMonth?"Generating...":`${thisSnap?"✓ Month Closed":"Close Month"}`}
          </button>
        </div>
      </div>
      ...
      {/* P&L header */}
      <div style={{...slcard(),background:"#080c18",border:`1px solid ${SL.border}`}}>
        <div style={{fontSize:9,color:"rgba(255,255,255,0.4)",letterSpacing:2,textTransform:"uppercase",fontFamily:"'JetBrains Mono',monospace",marginBottom:10}}>Business Health — {fmtMonth(activeMonth)}</div>
        <div style={{display:"grid",gridTemplateColumns:"repeat(5,1fr)",gap:12}}>
          {[
            {l:"Revenue",     v:`${cur}${revenue.toLocaleString()}`,     c:"34d399"},
            {l:"Expenses",    v:`${cur}${totalMonth.toLocaleString()}`,   c:"f87171"},
            {l:"Mkt Spend",   v:`${cur}${mktSpend.toLocaleString()}`,     c:"f59e0b"},
            {l:"Mkt % Rev",   v:`${mktPct}%`,c:parseFloat(mktPct)>15?"f87171":parseFloat(mktPct)>8?"f59e0b":"34d399"},
            {l:"Net Profit",  v:`${cur}${netProfit.toLocaleString()}`,    c:netProfit>=0?"34d399":"f87171"},
          ].map(s=>(
            <div key={s.l}>
              <div style={{fontSize:20,fontWeight:900,color:`#${s.c}`,fontFamily:"'JetBrains Mono',monospace",letterSpacing:-0.5}}>{s.v}</div>
              <div style={{fontSize:9,color:"rgba(255,255,255,0.4)",textTransform:"uppercase",letterSpacing:1,fontFamily:"'JetBrains Mono',monospace",marginTop:2}}>{s.l}</div>
            </div>
          ))}
        </div>
        {parseFloat(mktPct)>0&&(
          <div style={{marginTop:10,padding:"6px 10px",borderRadius:5,background:parseFloat(mktPct)>15?"rgba(239,68,68,0.1)":parseFloat(mktPct)>8?"rgba(245,158,11,0.1)":"rgba(16,185,129,0.1)",border:`1px solid ${parseFloat(mktPct)>15?"rgba(239,68,68,0.3)":parseFloat(mktPct)>8?"rgba(245,158,11,0.3)":"rgba(16,185,129,0.3)"}`}}>
            <span style={{fontSize:9.5,color:parseFloat(mktPct)>15?SL.red:parseFloat(mktPct)>8?SL.amber:SL.green,fontWeight:600}}>
              {parseFloat(mktPct)>15?`⚠️ Marketing at ${mktPct}% of revenue — review channel ROI`:parseFloat(mktPct)>8?`📊 Marketing at ${mktPct}% — healthy range (5–15%)`:parseFloat(mktPct)<=5&&mktPct>0?`📊 Marketing at ${mktPct}% — consider investing more in growth`:`✓ Marketing spend efficient at ${mktPct}% of revenue`}
            </span>
          </div>
        )}
      </div>

      {/* Two-col: expense logger + channel ROI */}
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:14,alignItems:"start"}}>

        {/* Expense logger — persistent */}
        <div style={slcard()}>
          <div style={{fontSize:12,fontWeight:800,color:SL.text,marginBottom:2}}>Expense Log</div>
          <div style={{fontSize:10,color:SL.muted,marginBottom:10}}>All entries saved permanently · CSV export includes full year · For IRAS reference</div>

          {/* Add expense form */}
          <div style={{background:SL.bgSec,borderRadius:8,padding:"10px 12px",marginBottom:10}}>
            <div style={{display:"flex",flexDirection:"column",gap:6}}>
              <input value={expInput} onChange={e=>setExpInput(e.target.value)} placeholder="Description e.g. Facebook ads April"
                style={{background:SL.bgCard,border:`1px solid ${SL.border}`,borderRadius:5,padding:"6px 9px",fontSize:11,color:SL.text,outline:"none",fontFamily:"inherit"}}/>
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:6}}>
                <input value={expAmount} onChange={e=>setExpAmount(e.target.value)} placeholder={`Amount (${cur})`} type="number"
                  style={{background:SL.bgCard,border:`1px solid ${SL.border}`,borderRadius:5,padding:"6px 9px",fontSize:11,color:SL.text,outline:"none",fontFamily:"inherit"}}/>
              ...
              <select value={expCat} onChange={e=>setExpCat(e.target.value)}
                style={{background:SL.bgCard,border:`1px solid ${SL.border}`,borderRadius:5,padding:"6px 9px",fontSize:11,color:SL.text,fontFamily:"inherit",cursor:"pointer"}}>
                {CATS.map(c=><option key={c.id} value={c.id}>{c.label}{c.flag?` (${c.flag})`:""}</option>)}
              </select>
              <input value={expNote} onChange={e=>setExpNote(e.target.value)} placeholder="Notes (optional)"
                style={{background:SL.bgCard,border:`1px solid ${SL.border}`,borderRadius:5,padding:"6px 9px",fontSize:11,color:SL.text,outline:"none",fontFamily:"inherit"}}/>
              <button onClick={addExpense} disabled={!expInput.trim()||!expAmount}
                style={{...slbtn(industry.color,{fontSize:11,justifyContent:"center",opacity:!expInput.trim()||!expAmount?0.4:1})}}>
                + Add Expense
              </button>
            </div>
          </div>
          ...
          {monthExps.length===0&&<div style={{fontSize:10,color:SL.dim,textAlign:"center",padding:"8px 0",fontStyle:"italic"}}>No expenses logged for {fmtMonth(activeMonth)}</div>}
          <div style={{display:"flex",flexDirection:"column",gap:3,maxHeight:240,overflowY:"auto"}}>
            {monthExps.sort((a,b)=>b.date.localeCompare(a.date)).map(e=>{
              const cat=catMap[e.cat];
              return(
                <div key={e.id} style={{display:"flex",gap:7,alignItems:"center",background:SL.bgSec,borderRadius:5,padding:"5px 9px"}}>
                  <span style={{...sltag(cat?.color||SL.dim),fontSize:7.5,flexShrink:0}}>{cat?.label?.split(" ")[0]?.toUpperCase()||e.cat.toUpperCase()}</span>
                  <div style={{flex:1,minWidth:0}}>
                    <div style={{fontSize:10,color:SL.text,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{e.label}</div>
                    <div style={{fontSize:8.5,color:SL.dim}}>{e.date}{cat?.ded===50?" · 50% deductible":""}{e.note?` · ${e.note}`:""}</div>
                  </div>
                  <span style={{fontSize:11,fontWeight:700,color:SL.red,fontFamily:"'JetBrains Mono',monospace",flexShrink:0}}>{cur}{e.amount}</span>
                  <button onClick={()=>saveExpenses(allExpenses.filter(x=>x.id!==e.id))} style={{fontSize:11,color:SL.dim,background:"none",border:"none",cursor:"pointer",flexShrink:0}}>×</button>
                </div>
              );
            })}
          </div>

          {/* Month total + YTD summary */}
          {monthExps.length>0&&(
            <div style={{marginTop:8,padding:"8px 10px",background:SL.bgSec,borderRadius:6,border:`1px solid ${SL.border}`}}>
              <div style={{display:"flex",justifyContent:"space-between",marginBottom:3}}>
                <span style={{fontSize:10,color:SL.muted}}>{fmtMonth(activeMonth)} total</span>
                <span style={{fontSize:11,fontWeight:700,color:SL.red,fontFamily:"'JetBrains Mono',monospace"}}>{cur}{totalMonth.toLocaleString()}</span>
              </div>
              <div style={{display:"flex",justifyContent:"space-between",marginBottom:3}}>
                <span style={{fontSize:10,color:SL.muted}}>YTD total ({activeMonth.slice(0,4)})</span>
                <span style={{fontSize:11,fontWeight:700,color:SL.muted,fontFamily:"'JetBrains Mono',monospace"}}>{cur}{totalYTD.toLocaleString()}</span>
              </div>
              <div style={{display:"flex",justifyContent:"space-between",paddingTop:4,borderTop:`1px solid ${SL.border}`}}>
                <span style={{fontSize:10,color:SL.tealL}}>Est. deductible (YTD)</span>
                <span style={{fontSize:11,fontWeight:700,color:SL.tealL,fontFamily:"'JetBrains Mono',monospace"}}>{cur}{deductYTD.toLocaleString()}</span>
              </div>
            </div>
          )}
          <div style={{fontSize:8.5,color:SL.dim,marginTop:6,fontStyle:"italic",textAlign:"center"}}>For reference only — consult a tax professional for your actual IRAS filing</div>
        </div>

        {/* Right col: marketing ROI + AI insight */}
        <div style={{display:"flex",flexDirection:"column",gap:12}}>

          {/* Marketing channel ROI */}
          <div style={slcard()}>
            <div style={{fontSize:12,fontWeight:800,color:SL.text,marginBottom:4}}>Marketing Channel ROI</div>
            <div style={{fontSize:10,color:SL.muted,marginBottom:10}}>Revenue per channel vs spend — assign deal sources in Pipeline</div>
            {Object.keys(channels).length===0?(
              <div style={{fontSize:10,color:SL.dim,textAlign:"center",padding:"12px 0",fontStyle:"italic"}}>Assign deal sources in the Pipeline tab to see ROI per channel</div>
            ):(
              <div style={{display:"flex",flexDirection:"column",gap:5}}>
                {Object.entries(channels).sort((a,b)=>b[1].revenue-a[1].revenue).map(([ch,d])=>{
                  const spend=channelSpend[ch]||0;
                  const roi=spend>0?(d.revenue/spend).toFixed(1):"∞";
                  const roiC=spend===0?SL.green:parseFloat(roi)>5?SL.green:parseFloat(roi)>2?SL.amber:SL.red;
                  return(
                    <div key={ch} style={{display:"grid",gridTemplateColumns:"1fr auto auto auto auto",gap:6,alignItems:"center",background:SL.bgSec,borderRadius:5,padding:"6px 9px"}}>
                      <span style={{fontSize:10,fontWeight:600,color:SL.text}}>{ch}</span>
                      <span style={{fontSize:9.5,color:SL.muted,fontFamily:"'JetBrains Mono',monospace"}}>{d.clients}cl</span>
                      <span style={{fontSize:10,fontWeight:700,color:SL.green,fontFamily:"'JetBrains Mono',monospace"}}>{cur}{d.revenue.toLocaleString()}</span>
                      <span style={{fontSize:9,color:SL.dim}}>{spend?`${cur}${spend}`:"—"}</span>
                      <span style={{...sltag(roiC),fontWeight:800,fontSize:9}}>{roi}x</span>
                    </div>
                  );
                })}
              </div>
          ...
          <div style={slcard()}>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8}}>
              <div>
                <div style={{fontSize:12,fontWeight:800,color:SL.text}}>🧠 Marketing Intelligence</div>
                <div style={{fontSize:10,color:SL.muted}}>Cut / invest recommendations based on your data</div>
              </div>
              <button onClick={async()=>{
                setLoadingInsight(true);
                const channelData=Object.entries(channels).map(([ch,d])=>`${ch}: ${d.clients} clients, ${cur}${d.revenue} revenue, spend: ${cur}${channelSpend[ch]||0}`).join(" | ")||"No source data yet";
                const system=`You are Aether Solo — business intelligence advisor for ${industry.bizName}, a ${industry.role}.
Analyse their marketing and expense data. Give 3 specific, actionable insights:
1. Which channel delivers best ROI — should receive more investment
2. Which spend delivers zero return — should be cut or reduced  
3. One specific action THIS WEEK based on the data
Be direct and commercial. Reference actual numbers. Max 180 words.`;
                const ctx=`Revenue: ${cur}${revenue} | Expenses: ${cur}${totalMonth} | Mkt spend: ${cur}${mktSpend} (${mktPct}% rev) | Net: ${cur}${netProfit}
Channels: ${channelData}
Expenses: ${monthExps.map(e=>`${e.label} ${cur}${e.amount} (${catMap[e.cat]?.label||e.cat})`).join(", ")||"None"}`;
                try{const r=await callClaude([{role:"user",content:ctx}],system,false,"insight");setInsight(r.text);}
                catch(e){setInsight("Add VITE_ANTHROPIC_KEY to generate marketing insights.");}
                setLoadingInsight(false);
              }} disabled={loadingInsight} style={{...slbtn(industry.color,{fontSize:10,padding:"5px 10px",opacity:loadingInsight?0.6:1})}}>
                {loadingInsight?"...":"Get Insights"}
              </button>
            </div>
            {insight?(
              <div style={{background:SL.bgSec,borderRadius:6,padding:"10px 11px",fontSize:10.5,color:SL.muted,lineHeight:1.7}}><Md text={insight}/></div>
            ):(
              <div style={{background:SL.bgSec,borderRadius:6,padding:"12px",textAlign:"center"}}>
                <div style={{fontSize:10,color:SL.dim,fontStyle:"italic"}}>Log expenses + assign deal sources in Pipeline, then get channel-specific cut/invest recommendations</div>
              </div>
            )}
          </div>
        </div>
      ...
      {snapshots.length>0&&(
        <div style={slcard()}>
          <div style={{fontSize:12,fontWeight:800,color:SL.text,marginBottom:10}}>📋 Monthly Business Reviews</div>
          <div style={{display:"flex",flexDirection:"column",gap:8}}>
            {snapshots.map(snap=>(
              <div key={snap.id} style={{background:SL.bgSec,borderRadius:8,border:`1px solid ${SL.border}`,overflow:"hidden"}}>
                <div style={{background:`${industry.color}10`,borderBottom:`1px solid ${SL.border}`,padding:"8px 12px",display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                  <div style={{fontSize:12,fontWeight:700,color:industry.color}}>{snap.label}</div>
                  <div style={{display:"flex",gap:10,alignItems:"center"}}>
                    <span style={{fontSize:10,fontFamily:"'JetBrains Mono',monospace",color:SL.green}}>{cur}{snap.revenue?.toLocaleString()}</span>
                    <span style={{fontSize:10,fontFamily:"'JetBrains Mono',monospace",color:SL.red}}>−{cur}{snap.expenses?.toLocaleString()}</span>
                    <span style={{...sltag(snap.netProfit>=0?SL.green:SL.red),fontWeight:700}}>{snap.netProfit>=0?"+":""}{cur}{snap.netProfit?.toLocaleString()}</span>
                  </div>
                </div>
                <div style={{padding:"10px 12px",fontSize:10.5,color:SL.muted,lineHeight:1.7}}><Md text={snap.summary}/></div>
              </div>
            ))}
          </div>
        </div>
...
const SOLO_NAV=[
  {id:"dashboard", label:"My Numbers",          icon:"📊"},
  {id:"pipeline",  label:"Pipeline",            icon:"🔥"},
  {id:"health",    label:"Business Health",     icon:"💰"},
  {id:"engage",    label:"Customer Engagement", icon:"💬"},
...
function SoloApp({onBack}){
  ...
  const[bizHealth,setBizHealth]=useState({expenses:[],dealSources:[]});
  const[weeklyDigest,setWeeklyDigest]=useState(null);

  if(!industry){
    return(
      <div style={{height:"100vh",background:SL.bg,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:40,fontFamily:"'Inter',system-ui,sans-serif",color:SL.text}}>
        <style>{GS}</style>
        <button onClick={onBack} style={{position:"absolute",top:24,left:24,background:"transparent",border:"1px solid #334155",borderRadius:7,padding:"6px 12px",color:"#64748b",cursor:"pointer",fontSize:11,fontFamily:"inherit"}}>← Back</button>
        <div style={{textAlign:"center",marginBottom:40}}>
          <div style={{width:52,height:52,borderRadius:14,background:`linear-gradient(135deg,${SL.teal},${SL.tealL})`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:22,fontWeight:900,color:"#fff",margin:"0 auto 16px",boxShadow:`0 8px 32px ${SL.teal}40`}}>Æ</div>
          <div style={{fontSize:26,fontWeight:800,color:SL.text,marginBottom:6}}>What best describes you?</div>
          <div style={{fontSize:14,color:SL.muted}}>Aether Solo tailors your pipeline, benchmarks, and intelligence to your specific work.</div>
        </div>
        <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:16,width:"100%",maxWidth:780}}>
          {SOLO_INDUSTRIES.map(ind=>(
            <button key={ind.id} onClick={()=>{setIndustry(ind);setPage("dashboard");setContacts(ind.deals.map(d=>({id:d.id,name:d.name,phone:d.phone,type:d.type,note:d.note})));setBizHealth({expenses:[],dealSources:[]});setWeeklyDigest(null);}}
              style={{background:SL.bgCard,border:`1.5px solid ${SL.border}`,borderRadius:14,padding:"20px 18px",cursor:"pointer",textAlign:"left",transition:"all 0.18s",position:"relative",overflow:"hidden"}}
              onMouseEnter={e=>{e.currentTarget.style.border=`1.5px solid ${ind.color}60`;e.currentTarget.style.boxShadow=`0 4px 20px ${ind.color}25`;}}
              onMouseLeave={e=>{e.currentTarget.style.border=`1.5px solid ${SL.border}`;e.currentTarget.style.boxShadow="none";}}>
              <div style={{position:"absolute",top:0,left:0,right:0,height:3,background:`linear-gradient(90deg,${ind.color},transparent)`}}/>
              <div style={{fontSize:28,marginBottom:8}}>{ind.icon}</div>
              <div style={{fontSize:15,fontWeight:800,color:SL.text,marginBottom:4}}>{ind.label}</div>
              <div style={{fontSize:11,color:SL.muted,lineHeight:1.5}}>Demo: {ind.bizName} · {ind.role}</div>
              <div style={{fontSize:10,color:ind.color,marginTop:8,fontFamily:"'JetBrains Mono',monospace",letterSpacing:0.5}}>→ Enter Solo Mode</div>
            </button>
          ))}
        </div>
      </div>
  ...
  return(
    <div style={{display:"flex",height:"100vh",background:SL.bg,fontFamily:"'Inter',system-ui,sans-serif",color:SL.text,overflow:"hidden"}}>
      <style>{GS}</style>
      {/* Sidebar */}
      <aside style={{width:210,flexShrink:0,background:SL.bgCard,borderRight:`1px solid ${SL.border}`,display:"flex",flexDirection:"column",overflow:"hidden"}}>
        <div style={{padding:"14px 16px",borderBottom:`1px solid ${SL.border}`,display:"flex",alignItems:"center",gap:10}}>
          <div style={{width:32,height:32,borderRadius:8,background:`linear-gradient(135deg,${industry.color},${SL.tealL})`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:16,flexShrink:0}}>{industry.icon}</div>
          <div>
            <div style={{fontSize:12,fontWeight:800,color:SL.text,lineHeight:1}}>{industry.bizName}</div>
            <div style={{fontSize:9,fontFamily:"'JetBrains Mono',monospace",color:SL.muted,marginTop:2}}>{industry.role}</div>
          </div>
        </div>
        <div style={{padding:"8px 12px",borderBottom:`1px solid ${SL.border}`}}>
          <div style={{display:"flex",alignItems:"center",gap:6}}>
            <span style={{width:6,height:6,borderRadius:"50%",background:SL.green,display:"inline-block",animation:"pulse 2s infinite"}}/>
            <span style={{fontSize:9,fontFamily:"'JetBrains Mono',monospace",color:SL.green}}>AETHER ACTIVE</span>
          </div>
        </div>
        <nav style={{flex:1,padding:8,display:"flex",flexDirection:"column",gap:2}}>
          {SOLO_NAV.map(n=>(
            <button key={n.id} onClick={()=>setPage(n.id)} style={{display:"flex",alignItems:"center",gap:9,padding:"10px 12px",borderRadius:8,border:"none",cursor:"pointer",textAlign:"left",width:"100%",transition:"all 0.12s",background:page===n.id?`${industry.color}15`:"transparent",color:page===n.id?industry.color:SL.muted,fontWeight:page===n.id?700:400,fontSize:13,fontFamily:"inherit"}}>
              <span style={{fontSize:14}}>{n.icon}</span>{n.label}
              {page===n.id&&<div style={{marginLeft:"auto",width:3,height:16,borderRadius:2,background:industry.color}}/>}
            </button>
          ))}
          <div style={{marginTop:8,borderTop:`1px solid ${SL.border}`,paddingTop:8}}>
            <button onClick={()=>setIndustry(null)} style={{display:"flex",alignItems:"center",gap:9,padding:"10px 12px",borderRadius:8,border:"none",cursor:"pointer",width:"100%",background:"transparent",color:SL.dim,fontSize:12,fontFamily:"inherit"}}>⇄ Switch Persona</button>
          </div>
        </nav>
        <div style={{padding:"10px 12px",borderTop:`1px solid ${SL.border}`}}>
          <div style={{fontSize:10,color:SL.dim,marginBottom:6}}>Aether Solo · {industry.currencyCode}</div>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
            <span style={sltag(industry.color)}>SOLO PRO</span>
            <button onClick={onBack} style={{fontSize:10,color:SL.dim,background:"none",border:"none",cursor:"pointer"}}>← Back</button>
          </div>
          <div style={{display:"flex",justifyContent:"center",marginTop:8}}>
            <span style={{fontSize:9,fontFamily:"'JetBrains Mono',monospace",letterSpacing:2,padding:"3px 12px",borderRadius:20,border:`1px solid ${industry.color}40`,color:industry.color,background:`${industry.color}10`}}>DEMO</span>
          </div>
      ...
      {/* Main */}
      <main style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden"}}>
        <div style={{height:50,borderBottom:`1px solid ${SL.border}`,display:"flex",alignItems:"center",justifyContent:"space-between",padding:"0 20px",flexShrink:0,background:SL.bgCard}}>
          <div>
            <div style={{fontSize:13,fontWeight:700,color:SL.text}}>{SOLO_NAV.find(n=>n.id===page)?.label||"Dashboard"}</div>
            <div style={{fontSize:10,fontFamily:"'JetBrains Mono',monospace",color:SL.muted}}>{industry.bizName} · {industry.role} · {industry.location}</div>
          </div>
          <div style={{display:"flex",gap:8}}>
            <span style={sltag(industry.color)}>{industry.label.toUpperCase()}</span>
            <span style={sltag(SL.teal)}>CLAUDE POWERED</span>
          </div>
        </div>
        <div style={{flex:1,overflow:"hidden",display:"flex"}}>
          {page==="dashboard"&&<SoloDashboard industry={industry} bizHealth={bizHealth} weeklyDigest={weeklyDigest} setWeeklyDigest={setWeeklyDigest}/>}
          {page==="pipeline" &&<SoloPipeline  industry={industry} contacts={contacts} setContacts={setContacts} bizHealth={bizHealth} setBizHealth={setBizHealth}/>}
          {page==="health"   &&<SoloBusinessHealth industry={industry} bizHealth={bizHealth} setBizHealth={setBizHealth}/>}
          {page==="engage"   &&<SoloEngagement industry={industry} contacts={contacts}/>}
          {page==="calendar" &&<SoloCalendar  industry={industry}/>}
          {page==="copilot"  &&<SoloCopilot   industry={industry} bizHealth={bizHealth}/>}
        </div>
      </main>
    </div>
  );
